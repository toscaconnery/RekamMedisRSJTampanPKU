...
class CreateRiRencanaKlien1Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ri_rencana_klien_1', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('tanggal_9',10)->nullable();
            ...
            $table->string('k9')->nullable();
            $table->string('k10')->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('ri_rencana_klien_1');
    }
}
