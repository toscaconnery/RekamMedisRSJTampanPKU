...
class CreateRiRencanaKeperawatan3Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ri_rencana_keperawatan_3', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('ri_rencana_keperawatan_3');
    }
}
