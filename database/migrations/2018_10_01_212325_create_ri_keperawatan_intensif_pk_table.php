...
class CreateRiKeperawatanIntensifPkTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ri_keperawatan_intensif_pk', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('ri_keperawatan_intensif_pk');
    }
}
