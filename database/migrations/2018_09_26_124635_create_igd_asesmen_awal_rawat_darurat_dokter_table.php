...
class CreateIgdAsesmenAwalRawatDaruratDokterTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('igd_asesmen_awal_rawat_darurat_dokter', function (Blueprint $table) {
            ...
            $table->string('jam_pemeriksaan_laboratorium')->nullable();
            $table->string('jam_hasil_laboratorium')->nullable();
            ...
            $table->string('jam_pemeriksaan_radiologi')->nullable();
            $table->string('jam_hasil_radiologi')->nullable();
            $table->string('pemeriksaan_ekg')->nullable();
            $table->string('hasil_ekg')->nullable();
            $table->string('keterangan_ekg')->nullable();
            $table->string('jam_pemeriksaan_ekg')->nullable();
            $table->string('jam_hasil_ekg')->nullable();
            $table->string('pemeriksaan_lain')->nullable();
            $table->string('hasil_lain')->nullable();
            $table->string('keterangan_lain')->nullable();
            $table->string('jam_pemeriksaan_lain')->nullable();
            $table->string('jam_hasil_lain')->nullable();
            ...
            $table->string('alasan_rujuk')->nullable();
