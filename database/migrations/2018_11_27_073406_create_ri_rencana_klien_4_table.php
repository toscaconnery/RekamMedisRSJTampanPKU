...
class CreateRiRencanaKlien4Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ri_rencana_klien_4', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('ri_rencana_klien_4');
    }
}
