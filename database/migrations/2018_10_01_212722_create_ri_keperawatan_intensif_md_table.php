...
class CreateRiKeperawatanIntensifMdTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ri_keperawatan_intensif_md', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('ri_keperawatan_intensif_md');
    }
}
