...
class CreateRjTesKonselingHivTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('rj_tes_konseling_hiv', function (Blueprint $table) {
            ...
            $table->string('skl',1);
            $table->string('alasan_tes',15)->nullable();
            $table->string('dmn',1);
            ...
            $table->string('tgl_masuk_pdp',10)->nullable();
            $table->string('tl_tipk',5)->nullable();
            $table->string('shp',1);
            $table->string('tgl_konseling_pasca_tes',10)->nullable();
            $table->string('tha',1);
            $table->string('ktb',1);
