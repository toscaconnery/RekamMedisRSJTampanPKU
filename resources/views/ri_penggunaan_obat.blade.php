...
<head>
  ...
  <title>Catatan Penggunaan Obat (CPO) </title>
                ...
                <section class="panel">
                  ...
                  <div class="panel-body">
                    <form class="form-horizontal " action="#">
                      ...
                      <div class="form-group">
                        <label class="col-sm-4 control-label"> Keluar</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control">
                        </div>
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <label class="checkbox-inline">
                                              <input type="checkbox" id="inlineCheckbox1" value="Baik"> Pagi
                                          </label>
                      <label class="checkbox-inline">
                                              <input type="checkbox" id="inlineCheckbox2" value="Cemas"> Siang
                                          </label>
                      <label class="checkbox-inline">
                                              <input type="checkbox" id="inlineCheckbox3" value="Takut"> Malam
                                          </label>
                    </div>
                  </div>
                  <div class="form-group">
