...
<body>
 ...
 <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i> RENCANA PEMULANGAN PASIEN (DISCHARGE P</h3>
            <!--<ol class="breadcrumb">
                ...
                <form class="form-horizontal " method="get">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-10">
                      <div class="radio">
                        <label>
                          <input type="radio" name="a1" id="optionsRadios1" value="Ya" checked>
                          Ya
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="a1" id="optionsRadios1" value="Tidak" checked>
                          Tidak
                        </label>
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-10">
                      <div class="radio">
                        <label>
                          <input type="radio" name="a2" id="optionsRadios1" value="Ya" checked>
                          Ya
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="a2" id="optionsRadios1" value="Tidak" checked>
                          Tidak
                        </label>
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-10">
                      <div class="radio">
                        <label>
                          <input type="radio" name="a3" id="optionsRadios1" value="Ya" checked>
                          Ya
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="a3" id="optionsRadios1" value="Tidak" checked>
                          Tidak
                        </label>
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-10">
                      <div class="radio">
                        <label>
                          <input type="radio" name="a4" id="optionsRadios1" value="Ya" checked>
                          Ya
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="a4" id="optionsRadios1" value="Tidak" checked>
                          Tidak
                        </label>
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="radio">
                        <label>
                          <input type="radio" name="a5" id="optionsRadios1" value="Ya" checked>
                          Ya
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="a5" id="optionsRadios1" value="Tidak" checked>
                          Tidak
                        </label>
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="radio">
                        <label>
                          <input type="radio" name="a6" id="optionsRadios1" value="Ya" checked>
                          Ya
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="a6" id="optionsRadios1" value="Tidak" checked>
                          Tidak
                        </label>
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="radio">
                        <label>
                          <input type="radio" name="a7" id="optionsRadios1" value="Ya" checked>
                          Ya
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="a7" id="optionsRadios1" value="Tidak" checked>
                          Tidak
                        </label>
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="radio">
                        <label>
                          <input type="radio" name="a8" id="optionsRadios1" value="Ya" checked>
                          Ya
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="a8" id="optionsRadios1" value="Tidak" checked>
                          Tidak
                        </label>
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="radio">
                        <label>
                          <input type="radio" name="a9" id="optionsRadios1" value="Ya" checked>
                          Ya
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="a9" id="optionsRadios1" value="Tidak" checked>
                          Tidak
                        </label>
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="radio">
                        <label>
                          <input type="radio" name="a10" id="optionsRadios1" value="Ya" checked>
                          Ya
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="a10" id="optionsRadios1" value="Tidak" checked>
                          Tidak
                        </label>
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="radio">
                        <label>
                          <input type="radio" name="a11" id="optionsRadios1" value="Ya" checked>
                          Ya
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="a11" id="optionsRadios1" value="Tidak" checked>
                          Tidak
                        </label>
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="radio">
                        <label>
                          <input type="radio" name="a12" id="optionsRadios1" value="Ya" checked>
                          Ya
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="a12" id="optionsRadios1" value="Tidak" checked>
                          Tidak
                        </label>
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="radio">
                        <label>
                          <input type="radio" name="a13" id="optionsRadios1" value="Ya" checked>
                          Ya
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="a13" id="optionsRadios1" value="Tidak" checked>
                          Tidak
                        </label>
                      </div>
                    </div>
