...
<head>
  ...
  <title>Pelaporan Efek Samping Obat Komite Farmasi dan Terapi</title>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <form class="form-horizontal " method="get">
                  ...
                  <div class="form-group">
                    <label class="col-lg-2 control-label"> Penyakit Uratama</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control">
                    </div>
                  </div>
                  ...
                  <label class="control-label col-lg-2" for="inputSuccess">Kesudahan</label>
                    <div class="col-lg-2">
                      <div class="radio">
                        <label>
                                                  <input type="radio" name="a1" id="optionsRadios1" value="pernah" checked>
                                                  Sembuh 
                                              </label>
                      </div>
                      <div class="radio">
                ...
                <form class="form-horizontal " method="get">
                  ...
                  <label class="control-label col-lg-2" for="inputSuccess">Kesudahan E.S.O</label>
                    <div class="col-lg-2">
                      <div class="radio">
                        <label>
                                                  <input type="radio" name="a2" id="optionsRadios1" value="pernah" checked>
                                                  Sembuh 
                                              </label>
                      </div>
                      <div class="radio">
                  ...
                  <label class="control-label col-lg-2" for="inputSuccess">Apakah reaksi E.S.O hilang setelah obat dihentikan?</label>
                    <div class="col-lg-2">
                      ...
                      <div class="radio">
                        <label>
                                                  <input type="radio" name="a3" id="optionsRadios1" value="tidak tahu" checked>
                                                  Tidak Tahu
                                              </label>
                      </div>
                    </div>
                ...
                <form class="form-horizontal " method="get">
                  ...
                  <label class="control-label col-lg-2" for="inputSuccess">Profesi</label>
                    <div class="col-lg-2">
                      <div class="radio">
                        <label>
                                                  <input type="radio" name="a4" id="optionsRadios1" value="Dokter" checked>
                                                  Dokter
                                              </label>
                      </div>
                      <div class="radio">
                        <label>
                                                  <input type="radio" name="a4" id="optionsRadios1" value="Perawat" checked>
                                                  Perawat 
                                              </label>
                      </div>
                      <div class="radio">
                        <label>
                                                  <input type="radio" name="a4" id="optionsRadios1" value="farmasis" checked>
                                                  Farmasis
                                              </label>
                      </div>
                    </div>
