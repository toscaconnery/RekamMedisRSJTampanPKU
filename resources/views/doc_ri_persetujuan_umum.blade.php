...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td class="box" colspan="3">Dengan ini menyatakan bahwa saya telah menerangkan hal-hal di atas secara benar dan jelas memberikan kesempatan untuk bertanya dan berdiskusi</td>
        <td class="box-c">
    ...
    <tr>
      <td class="box" colspan="3">Dengan ini menyatakan bahwa saya telah memahami dan mengerti hal-hal di atas secara benar dan jelas</td>
      <td class="box-c">Nama dan TTD Pasien/Keluarga
          <br>
          <br>
          <br>
          <br>
