                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <a class="btn btn-success" href="{{url('')}}/pdf_ri_persetujuan_tindakan"><i class="icon_check_alt2"></i></a>
                        <a class="btn btn-danger" href="{{url('')}}/pdf_ri_penolakan_tindakan"><i class="icon_close_alt2"></i></a>
                      </div>
                    </td>
                  </tr>
                </tbody>
