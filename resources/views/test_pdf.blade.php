              ...
              <table class="table table-striped table-advance table-hover">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <a class="btn btn-primary" href="{{url('')}}/pdf_ri_rencana1"><i class="icon_plus_alt2"></i></a>
                        <a class="btn btn-success" href="{{url('')}}/pdf_ri_rencanaklien1"><i class="icon_check_alt2"></i></a>
