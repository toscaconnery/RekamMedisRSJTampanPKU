...
<body>
 ...
 <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i> PDF</h3>
            <!--<ol class="breadcrumb">
              ...
              <table class="table table-striped table-advance table-hover">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <a class="btn btn-primary" href="{{url('')}}/pdf_ri_permintaan_privasi"><i class="icon_plus_alt2"></i></a>
                        <a class="btn btn-success" href="{{url('')}}/pdf_rj_catatan_perkembangan"><i class="icon_check_alt2"></i></a>
                        <a class="btn btn-danger" href="{{url('')}}/pdf_ri_hakkewajiban"><i class="icon_close_alt2"></i></a>
                      </div>
                    </td>
                  </tr>
                </tbody>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <form class="form-horizontal " method="get">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Informasi yang disampaikan</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control">
                    </div>
                  </div>
