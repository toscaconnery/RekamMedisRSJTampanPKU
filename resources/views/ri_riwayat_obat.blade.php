...
<head>
  ...
  <title>Riwayat Penggunaan Obat (Rekonsiliasi Obat) </title>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <label class="checkbox-inline">
                                              <input type="checkbox" id="inlineCheckbox1" value="Baik"> Tidak ada Riwayat Alergi
                                          </label>
                    </div>
                  </div>
                </form>
                ...
                <form class="form-horizontal " method="get">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-10">
                      <div class="radio">
                        <label>
                                                  <input type="radio" name="a1" id="optionsRadios1" value="option1" checked>
                                                  Lanjut
                                              </label>
                      </div>
                      <div class="radio">
                      ...
                      <div class="radio">
                        <label>
                                                  <input type="radio" name="a1" id="optionsRadios2" value="option2">
                                                  Henti
                                              </label>
                      </div>
                    </div>
