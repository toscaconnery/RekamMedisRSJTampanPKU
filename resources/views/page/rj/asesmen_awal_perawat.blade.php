              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10" style="padding-left: 0px; padding-right: 0px;">
                    ...
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" value="3" name="status_psikososial3"> Takut
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" value="4" name="status_psikososial4"> Marah
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" value="5" name="status_psikososial5"> Sedih
                      </label>
                    </div>
                  </div>
                  <br>
                  ...
                  <div class="col-lg-10" style="padding-left: 0px; padding-right: 0px;">
                    <div class="col-lg-4">
                      <label class="checkbox-inline">
                        <input type="checkbox" value="6" name="status_psikososial6"> Kecendrungan bunuh diri dilaporkan ke : 
                      </label>
                    </div>
                    <div class="col-lg-6">
                      <input type="text" class="form-control" name="dilaporkan_ke" placeholder="dilaporkan ke...">
                    </div>
                  </div>
                  <br>
                  <label class="control-label col-lg-2" for="inputSuccess"></label>
                  <div class="col-lg-10" style="padding-left: 0px; padding-right: 0px;">
                    <div class="col-lg-4">
                      <label class="checkbox-inline">
                        <input type="checkbox" value="7" name="status_psikososial7"> Lain-lain
                      </label>
                    </div>
                    <div class="col-lg-6">
                      <input type="text" class="form-control" name="status_psikologis_lain" placeholder="sebutkan status psikologis lainnya">
                    </div>
                  </div>
                </div>
                <h4>Status Mental</h4>
                <div class="form-group">
                  ...
                  <div class="col-lg-10" style="padding-left: 0px; padding-right: 0px;">
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="konsep_diri1"> Gangguan citra tubuh
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="konsep_diri2"> Gangguan identitas
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="konsep_diri3"> Harga diri rendah
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="konsep_diri4"> Gangguan peran
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="konsep_diri5"> Tidak terkaji
                      </label>
                    </div>                    
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10" style="padding-left: 0px; padding-right: 0px;">
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="persepsi1"> Ilusi
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="persepsi2"> Halusinasi dengar
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="persepsi3"> Halusinasi lihat
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="persepsi4"> Halusinasi raba
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="persepsi5"> Halusinasi kecap
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="persepsi6"> Halusinasi hidu
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="persepsi7"> Tidak terkaji
                      </label>
                    </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10" style="padding-left: 0px; padding-right: 0px;">
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="motorik1"> Lesu
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="motorik2"> Tegang
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="motorik3"> Gelisah
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="motorik4"> TIK  
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="motorik5"> Grimasi  
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="motorik6"> Halusinasi hidu
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="motorik7"> Tremor
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="motorik8"> Konsulsif
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="motorik9"> Tidak ada Masalah
                      </label>
                    </div>                    
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10" style="padding-left: 0px; padding-right: 0px;">
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="penampilan1"> Rapi
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="penampilan2"> Tidak rapi
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="penampilan3"> Penggunaan tidak sesuai
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="penampilan4"> Cara berpakaian tidak seperti biasa
                      </label>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10" style="padding-left: 0px; padding-right: 0px;">
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir1"> Obsesi
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir2"> Phobia
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir3"> Hipokondria
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir4"> Depersonalisasi  
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir5"> Ide terkait 
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir6"> Pikiran magis
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir7"> Waham agama
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir8"> Waham somatik
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir9"> Waham besar
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir10"> Waham curiga
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir11"> Waham nihilistik
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir12"> Sisip pikir
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir13"> Siar pikir
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir14"> Kontrol pikir
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir15"> Tidak terkaji
                      </label>
                    </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <label class="checkbox-inline">
                      <input type="checkbox" name="perasaan1"> Sedih
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" name="perasaan2"> Ketakutan
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" name="perasaan3"> Putus asa
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" name="perasaan4"> Khawatir
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" name="perasaan5"> Gembira berlebihan
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" name="perasaan6"> Isyarat/Percobaan bunuh diri
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" name="perasaan7"> Sesuai
                    </label>
                  </div>
                </div>
              ...
              <div class="panel-body">
                ...
                <div class="form-group" id="must_1_form">
                  ...
                  <div class="col-lg-10">
                    ...
                    <div class="radio">
                      <label>
                        <input type="radio" name="must_1" id="must_1_3" value="3">
                        Ya
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group" id="must_23_form">
                  ...
                  <div class="col-lg-2">
                    <div class="radio">
                      <label>
                        <input type="radio" name="must_3" id="must_3_2" value="0">
                        Tidak 
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="must_3" id="must_3_1" value="1">
                        Ya 
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-2">
                    <div class="radio">
                      <label>
                        <input type="radio" name="pemberitahuan_fg" id="pemberitahuan_1" value="1">
                        Ya 
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="pemberitahuan_fg" id="pemberitahuan_2" value="0">
                        Tidak 
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="time" class="form-control" id="waktu_pemberitahuan_fg" name="waktu_pemberitahuan_fg">
                  </div>
                </div>
              </div>
            </section>
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-2">
                    <div class="radio">
                      <label>
                        <input type="radio" name="pemberitahuan_ny" value="1">
                        Ya 
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="pemberitahuan_ny" value="0">
                        Tidak 
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="time" class="form-control" name="waktu_pemberitahuan_ny">
                  </div>
                </div>
              </div>
            </section>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea name="implementasi" class="form-control" rows="8" cols="114" style="resize: none;"></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Evaluasi </label>
                  <div class="col-sm-8">
                    <textarea name="evaluasi" class="form-control" rows="8" cols="114" style="resize: none;"></textarea>
                  </div>
                </div>
                <div>
