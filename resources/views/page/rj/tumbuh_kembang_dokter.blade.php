              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  <div>
                    ...
                    <div class="col-sm-8">
                      <textarea readonly class="form-control required" name="bentuk_arus_pikir" rows="6" style="resize: none;"></textarea>
                    </div>
                  </div>
                  ...
                  <div style="float: left; padding: 0" class="col-sm-12">
                    ...
                    <div class="col-sm-8">
                      <textarea readonly class="form-control required" name="isi_pikir" rows="6" style="resize: none;"></textarea>
                    </div>
                  </div>
                </div>
                <div class="form-group">
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea class="form-control required" name="prognosis" rows="6" style="resize: none;"></textarea>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea class="form-control required" name="treatment_pasien" rows="6" style="resize: none;"></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Untuk Keluarga</label>
                  <div class="col-sm-8">
                    <textarea class="form-control required" name="treatment_keluarga" rows="6" style="resize: none;"></textarea>
                  </div>
                </div>
              </div>
            </section>
