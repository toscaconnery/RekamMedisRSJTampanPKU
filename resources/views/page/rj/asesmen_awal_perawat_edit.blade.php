    ...
    <section class="wrapper">
          ...
          <section class="panel">
            ...
            <table class="table table-striped table-advance table-hover">
              <tbody>
                ...
                <tr>
                  <td>Perawat</td>
                  <td>{{$tanggal_pengisian_perawat}}</td>
                  <td>{{$nama_pengisi_perawat}}</td>
                  <td>
                    <div class="btn-group">
                ...
                <tr>
                  <td>Dokter</td>
                  <td>{{$tanggal_pengisian_dokter}}</td>
                  <td>{{$nama_pengisi_dokter}}</td>
                  <td>
                    <div class="btn-group">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <form class="form-horizontal" method="post" action="rj_asesmen_awal_perawat_edit">
            {{ csrf_field() }}
            {{-- asesmen keperawatan --}}
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="alasan_kunjungan" value="{{$alasan_kunjungan}}" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <div class="radio">
                      <label>
                        <input type="radio" value="1" name="hubungan_keluarga" {{$hubungan_keluarga == 1 ? 'checked' : ''}}>
                        Baik
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" value="0" name="hubungan_keluarga" {{$hubungan_keluarga == 0 ? 'checked' : ''}}>
                        Tidak Baik
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10" style="padding-left: 0px; padding-right: 0px;">
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="status_psikososial1" {{isset($status_psikososial[1]) ? 'checked' : ''}}> Baik
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="status_psikososial2" {{isset($status_psikososial[2]) ? 'checked' : ''}}> Cemas
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="status_psikososial3" {{isset($status_psikososial[3]) ? 'checked' : ''}}> Takut
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="status_psikososial4" {{isset($status_psikososial[4]) ? 'checked' : ''}}> Marah
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="status_psikososial5" {{isset($status_psikososial[5]) ? 'checked' : ''}}> Sedih
                      </label>
                    </div>
                  </div>
                  <br>
                  ...
                  <div class="col-lg-10" style="padding-left: 0px; padding-right: 0px;">
                    <div class="col-lg-4">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="status_psikososial6" {{isset($status_psikososial[6]) ? 'checked' : ''}}> Kecendrungan bunuh diri dilaporkan ke : 
                      </label>
                    </div>
                    <div class="col-lg-6">
                      <input type="text" class="form-control" name="dilaporkan_ke" value="{{$dilaporkan_ke}}" placeholder="dilaporkan ke...">
                    </div>
                  </div>
                  <br>
                  <label class="control-label col-lg-2" for="inputSuccess"></label>
                  <div class="col-lg-10" style="padding-left: 0px; padding-right: 0px;">
                    <div class="col-lg-4">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="status_psikososial7" {{isset($status_psikososial[7]) ? 'checked' : ''}}> Lain-lain
                      </label>
                    </div>
                    <div class="col-lg-6">
                      <input type="text" class="form-control" name="status_psikologis_lain" value="{{$status_psikologis_lain}}" placeholder="sebutkan status psikologis lainnya">
                    </div>
                  </div>
                </div>
                <h4>Status Mental</h4>
                <div class="form-group">
                  ...
                  <div class="col-lg-10" style="padding-left: 0px; padding-right: 0px;">
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="konsep_diri1" {{isset($konsep_diri[1]) ? 'checked' : ''}}> Gangguan citra tubuh
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="konsep_diri2" {{isset($konsep_diri[2]) ? 'checked' : ''}}> Gangguan identitas
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="konsep_diri3" {{isset($konsep_diri[3]) ? 'checked' : ''}}> Harga diri rendah
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="konsep_diri4" {{isset($konsep_diri[4]) ? 'checked' : ''}}> Gangguan peran
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="konsep_diri5" {{isset($konsep_diri[5]) ? 'checked' : ''}}> Tidak terkaji
                      </label>
                    </div>                    
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10" style="padding-left: 0px; padding-right: 0px;">
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="persepsi1" {{isset($persepsi[1]) ? 'checked' : ''}}> Ilusi
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="persepsi2" {{isset($persepsi[2]) ? 'checked' : ''}}> Halusinasi dengar
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="persepsi3" {{isset($persepsi[3]) ? 'checked' : ''}}> Halusinasi lihat
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="persepsi4" {{isset($persepsi[4]) ? 'checked' : ''}}> Halusinasi raba
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="persepsi5" {{isset($persepsi[5]) ? 'checked' : ''}}> Halusinasi kecap
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="persepsi6" {{isset($persepsi[6]) ? 'checked' : ''}}> Halusinasi hidu
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="persepsi7" {{isset($persepsi[7]) ? 'checked' : ''}}> Tidak terkaji
                      </label>
                    </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10" style="padding-left: 0px; padding-right: 0px;">
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="motorik1" {{isset($motorik[1]) ? 'checked' : ''}}> Lesu
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="motorik2" {{isset($motorik[2]) ? 'checked' : ''}}> Tegang
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="motorik3" {{isset($motorik[3]) ? 'checked' : ''}}> Gelisah
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="motorik4" {{isset($motorik[4]) ? 'checked' : ''}}> TIK  
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="motorik5" {{isset($motorik[5]) ? 'checked' : ''}}> Grimasi  
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="motorik6" {{isset($motorik[6]) ? 'checked' : ''}}> Halusinasi hidu
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="motorik7" {{isset($motorik[7]) ? 'checked' : ''}}> Tremor
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="motorik8" {{isset($motorik[8]) ? 'checked' : ''}}> Konsulsif
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="motorik9" {{isset($motorik[9]) ? 'checked' : ''}}> Tidak ada Masalah
                      </label>
                    </div>                    
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10" style="padding-left: 0px; padding-right: 0px;">
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="penampilan1" {{isset($penampilan[1]) ? 'checked' : ''}}> Rapi
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="penampilan2" {{isset($penampilan[2]) ? 'checked' : ''}}> Tidak rapi
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="penampilan3" {{isset($penampilan[3]) ? 'checked' : ''}}> Penggunaan tidak sesuai
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="penampilan4" {{isset($penampilan[4]) ? 'checked' : ''}}> Cara berpakaian tidak seperti biasa
                      </label>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10" style="padding-left: 0px; padding-right: 0px;">
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir1" {{isset($pikir[1]) ? 'checked' : ''}}> Obsesi
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir2" {{isset($pikir[2]) ? 'checked' : ''}}> Phobia
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir3" {{isset($pikir[3]) ? 'checked' : ''}}> Hipokondria
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir4" {{isset($pikir[4]) ? 'checked' : ''}}> Depersonalisasi  
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir5" {{isset($pikir[5]) ? 'checked' : ''}}> Ide terkait 
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir6" {{isset($pikir[6]) ? 'checked' : ''}}> Pikiran magis
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir7" {{isset($pikir[7]) ? 'checked' : ''}}> Waham agama
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir8" {{isset($pikir[8]) ? 'checked' : ''}}> Waham somatik
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir9" {{isset($pikir[9]) ? 'checked' : ''}}> Waham besar
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir10" {{isset($pikir[10]) ? 'checked' : ''}}> Waham curiga
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir11" {{isset($pikir[11]) ? 'checked' : ''}}> Waham nihilistik
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir12" {{isset($pikir[12]) ? 'checked' : ''}}> Sisip pikir
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir13" {{isset($pikir[13]) ? 'checked' : ''}}> Siar pikir
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir14" {{isset($pikir[14]) ? 'checked' : ''}}> Kontrol pikir
                      </label>
                    </div>
                    <div class="col-lg-2">
                      <label class="checkbox-inline">
                        <input type="checkbox" name="pikir15" {{isset($pikir[15]) ? 'checked' : ''}}> Tidak terkaji
                      </label>
                    </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <label class="checkbox-inline">
                      <input type="checkbox" name="perasaan1" {{isset($perasaan[1]) ? 'checked' : ''}}> Sedih
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" name="perasaan2" {{isset($perasaan[2]) ? 'checked' : ''}}> Ketakutan
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" name="perasaan3" {{isset($perasaan[3]) ? 'checked' : ''}}> Putus asa
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" name="perasaan4" {{isset($perasaan[4]) ? 'checked' : ''}}> Khawatir
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" name="perasaan5" {{isset($perasaan[5]) ? 'checked' : ''}}> Gembira berlebihan
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" name="perasaan6" {{isset($perasaan[6]) ? 'checked' : ''}}> Isyarat/Percobaan bunuh diri
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" name="perasaan7" {{isset($perasaan[7]) ? 'checked' : ''}}> Sesuai
                    </label>
                  </div>
                </div>
                ...
                <div class="form-group" id="status_fungsional">
                  ...
                  <div class="col-lg-10">
                    <div class="radio">
                      <label>
                        <input type="radio" id="status_fungsional_1" value="Mandiri" name="status_fungsional" {{$status_fungsional == 'Mandiri' ? 'checked' : ''}}>
                        Mandiri
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" id="status_fungsional_2" value="Perlu Bantuan" name="status_fungsional" {{$status_fungsional == 'Perlu Bantuan' ? 'checked' : ''}}>
                        Perlu Bantuan
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" id="status_fungsional_3" value="Ketergantungan Total" name="status_fungsional" {{$status_fungsional == 'Ketergantungan Total' ? 'checked' : ''}}>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="perlu_bantuan" id="perlu_bantuan" {{$status_fungsional != 'Perlu Bantuan' ? 'disabled' : ''}} value="{{$status_fungsional == 'Perlu Bantuan' ? $perlu_bantuan : ''}}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="time" class="form-control" name="waktu_laporan" value="{{$waktu_laporan}}">
                  </div>
                </div>
              ...
              <div class="panel-body">
                ...
                <div class="form-group" id="must_1_form">
                  ...
                  <div class="col-lg-10">
                    <div class="radio">
                      <label>
                        <input type="radio" name="must_1" id="must_1_1" value="0" {{$must_1 == 0 ? 'checked' : ''}}>
                        Tidak ada penurunan berat badan
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="must_1" id="must_1_2" value="2" {{$must_1 == 2 ? 'checked' : ''}}>
                        Tidak yakin/ tidak tahu/ terasa baju longgar 
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="must_1" id="must_1_3" value="3" {{$must_1 == 3 ? 'checked' : ''}}>
                        Ya
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group" id="must_23_form">
                  ...
                  <div class="col-lg-2">
                    <div class="radio">
                      <label>
                        <input type="radio" name="must_2" value="0" {{$must_2 == 0 ? 'checked' : ''}}>
                        Tidak 
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="must_2" value="1" {{$must_2 == 1 ? 'checked' : ''}}>
                        Ya 
                      </label>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-2">
                    <div class="radio">
                      <label>
                        <input type="radio" name="must_3" id="must_3_2" value="0" {{$must_3 == 0 ? 'checked' : ''}}>
                        Tidak 
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="must_3" id="must_3_1" value="1" {{$must_3 == 1 ? 'checked' : ''}}>
                        Ya 
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-2">
                    <div class="radio">
                      <label>
                        <input type="radio" name="sk_1" value="0" {{$sk_1 == 0 ? 'checked' : ''}}>
                        Tidak 
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="sk_1" value="1" {{$sk_1 == 1 ? 'checked' : ''}}>
                        Ya 
                      </label>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-2">
                    <div class="radio">
                      <label>
                        <input type="radio" name="sk_2" value="0" {{$sk_2 == 0 ? 'checked' : ''}}>
                        Tidak 
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="sk_2" value="1" {{$sk_2 == 1 ? 'checked' : ''}}>
                        Ya 
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="radio">
                      <label>
                        <input type="radio" name="sk_3" value="0" {{$sk_3 == 0 ? 'checked' : ''}}>
                        Tidak 
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="sk_3" value="1" {{$sk_3 == 1 ? 'checked' : ''}}>
                        Ya 
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-2">
                    <div class="radio">
                      <label>
                        <input type="radio" name="sk_4" value="0" {{$sk_4 == 0 ? 'checked' : ''}}>
                        Tidak 
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="sk_4" value="1" {{$sk_4 == 1 ? 'checked' : ''}}>
                        Ya 
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-2">
                    <div class="radio">
                      <label>
                        <input type="radio" name="pemberitahuan_fg" id="pemberitahuan_1" value="1" {{$pemberitahuan_fg == 1 ? 'checked' : ''}}>
                        Ya 
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="pemberitahuan_fg" id="pemberitahuan_2" value="0" {{$pemberitahuan_fg == 0 ? 'checked' : ''}}>
                        Tidak 
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="time" class="form-control" id="waktu_pemberitahuan_fg" name="waktu_pemberitahuan_fg" value="{{$waktu_pemberitahuan_fg}}">
                  </div>
                </div>
              </div>
            </section>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group" id="field_nyeri_hilang">
                  ...
                  <div class="col-sm-2">
                    <input type="text" class="form-control" name="nyeri_hilang_input_text" value="{{$nyeri_hilang_input_text}}">
                  </div>
                </div>
                @endif
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-2">
                    <div class="radio">
                      <label>
                        <input type="radio" name="pemberitahuan_ny" value="1" {{$pemberitahuan_ny == 1 ? 'checked' : ''}}>
                        Ya 
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="pemberitahuan_ny" value="0" {{$pemberitahuan_ny == 0 ? 'checked' : ''}}>
                        Tidak 
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="time" class="form-control" name="waktu_pemberitahuan_ny" value="{{$waktu_pemberitahuan_ny}}">
                  </div>
                </div>
              </div>
            </section>
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-lg-4">
                    <div class="radio">
                      <label>
                        <input type="radio" name="jenis_resiko_jatuh" value="humpty_dumpty" {{$jenis_resiko_jatuh == 'humpty_dumpty' ? 'checked' : ''}}>
                        HUMPTY DUMPTY (Anak-anak) 
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="jenis_resiko_jatuh" value="morse" {{$jenis_resiko_jatuh == 'morse' ? 'checked' : ''}}>
                        MORSE (Dewasa) 
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="jenis_resiko_jatuh" value="edmunson" {{$jenis_resiko_jatuh == 'edmunson' ? 'checked' : ''}}>
                        EDMUNSON (Jiwa) 
                      </label>
                    </div>
                  </div>
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-lg-4">
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="umum_1" {{isset($umum[1]) ? 'checked' : ''}}>
                    ...
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="umum_2" {{isset($umum[2]) ? 'checked' : ''}}>
                        Aktual/ Resiko aspirasi
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="umum_3" {{isset($umum[3]) ? 'checked' : ''}}>
                        Aktual/ Resiko pola nafas tidak efektif
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="umum_4" {{isset($umum[4]) ? 'checked' : ''}}>
                        Aktual/ Resiko gangguan pertukaran gas
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="umum_5" {{isset($umum[5]) ? 'checked' : ''}}>
                        Aktual/ penurunan curah jantung
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="umum_6" {{isset($umum[6]) ? 'checked' : ''}}>
                        Aktual/ Resiko gangguan perfusi jaringan celebral/perifer
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="umum_7" {{isset($umum[7]) ? 'checked' : ''}}>
                        Aktual/ Resiko gangguan keseimbangan cairan
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="umum_8" {{isset($umum[8]) ? 'checked' : ''}}>
                        Aktual/ Resiko gangguan keseimbangan kontinuitas jaringan
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="umum_9" {{isset($umum[9]) ? 'checked' : ''}}>
                        Aktual/ Resiko infeksi
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="umum_10" {{isset($umum[10]) ? 'checked' : ''}}>
                        Resiko cedera / jatuh
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="umum_11" {{isset($umum[11]) ? 'checked' : ''}}>
                        Hypertermi
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="umum_12" {{isset($umum[12]) ? 'checked' : ''}}>
                        Nyeri
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="umum_13" {{isset($umum[13]) ? 'checked' : ''}}>
                        Gangguan kebutuhan nutrisi
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="umum_14" {{isset($umum[14]) ? 'checked' : ''}}>
                        Lainnya
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Sebutkan </label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="umum_lainnya" value="{{$umum_lainnya}}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-6">
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="jiwa_1" {{isset($jiwa[1]) ? 'checked' : ''}}>
                        Gangguan persepsi sensori : halusinasi
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="jiwa_2" {{isset($jiwa[2]) ? 'checked' : ''}}>
                        Perilaku kekerasan
                      </label>
                    </div>
                    ...
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="jiwa_3" {{isset($jiwa[3]) ? 'checked' : ''}}>
                        Isolasi sosial
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="jiwa_4" {{isset($jiwa[4]) ? 'checked' : ''}}>
                        Gangguan konsep diri
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="jiwa_5" {{isset($jiwa[5]) ? 'checked' : ''}}>
                        Resiko bunuh diri
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="jiwa_6" {{isset($jiwa[6]) ? 'checked' : ''}}>
                        Intoleransi aktifitas
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="jiwa_7" {{isset($jiwa[7]) ? 'checked' : ''}}>
                        Waham
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="jiwa_8" {{isset($jiwa[8]) ? 'checked' : ''}}>
                        Defisit perawatan diri
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="jiwa_9" {{isset($jiwa[9]) ? 'checked' : ''}}>
                    ...
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="jiwa_10" {{isset($jiwa[10]) ? 'checked' : ''}}>
                    ...
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="jiwa_11" {{isset($jiwa[11]) ? 'checked' : ''}}>
                    ...
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="jiwa_12" {{isset($jiwa[12]) ? 'checked' : ''}}>
                        Lainnya
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Sebutkan </label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="jiwa_lainnya" value="{{$jiwa_lainnya}}">
                  </div>
                </div>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea name="implementasi" class="form-control" rows="8" cols="114" style="resize: none;">{{$implementasi}}</textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Evaluasi </label>
                  <div class="col-sm-8">
                    <textarea name="evaluasi" class="form-control" rows="8" cols="114" style="resize: none;">{{$evaluasi}}</textarea>
                  </div>
                </div>
                <div>
