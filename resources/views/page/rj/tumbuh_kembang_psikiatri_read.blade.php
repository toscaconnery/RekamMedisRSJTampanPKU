          ...
          <section class="panel">
            ...
            <div class="panel-body">
             <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" disabled class="form-control" name="f1" value="{{$f1}}">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">ANAMNESIS </label>
              <div class="col-sm-8">
                <input type="text" disabled class="form-control" name="f2" value="{{$f2}}">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">PEMERIKSAAN FISIK </label>
              <div class="col-sm-8">
                <input type="text" disabled class="form-control" name="f3" value="{{$f3}}">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">PEMERIKSAAN PSIKIATRIK </label>
              <div class="col-sm-8">
                <input type="text" disabled class="form-control" name="f4" value="{{$f4}}">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">PEMERIKSAAN PENUNJANG </label>
              <div class="col-sm-8">
                <input type="text" disabled class="form-control" name="f5" value="{{$f5}}">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">DIAGNOSIS MEDIS (ICD – 10)</label>
              <div class="col-sm-8">
                <input type="text" disabled class="form-control" name="f6" value="{{$f6}}">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">TERAPI PSIKOFARMAKA </label>
              <div class="col-sm-8">
                <input type="text" disabled class="form-control" name="f7" value="{{$f7}}">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="text" disabled class="form-control" name="r1" value="{{$r1}}">
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <input type="text" disabled class="form-control" name="t2" value="{{$t2}}">
              </div>
              <label class="col-sm-1 control-label">Frekuensi</label>
              <div class="col-sm-2">
                <input type="text" disabled class="form-control" name="r2" value="{{$r2}}">
              </div>
              <label class="col-sm-1 control-label" style="text-align: left; padding-left: 0px;">x/minggu</label>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <input type="text" disabled class="form-control" name="t3" value="{{$t3}}">
              </div>
              <label class="col-sm-1 control-label">Frekuensi</label>
              <div class="col-sm-2">
                <input type="text" disabled class="form-control" name="r3" value="{{$r3}}">
              </div>
              <label class="col-sm-1 control-label" style="text-align: left; padding-left: 0px;">x/minggu</label>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Sensori Integrasi  </label>
              <div class="col-sm-4">
                <input type="text" disabled class="form-control" name="t4" value="{{$t4}}">
              </div>
              <label class="col-sm-1 control-label">Frekuensi</label>
              <div class="col-sm-2">
                <input type="text" disabled class="form-control" name="r4" value="{{$r4}}">
              </div>
              <label class="col-sm-1 control-label" style="text-align: left; padding-left: 0px;">x/minggu</label>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <input type="text" disabled class="form-control" name="t5" value="{{$t5}}">
              </div>
              <label class="col-sm-1 control-label">Frekuensi</label>
              <div class="col-sm-2">
                <input type="text" disabled class="form-control" name="r5" value="{{$r5}}">
              </div>
              <label class="col-sm-1 control-label" style="text-align: left; padding-left: 0px;">x/minggu</label>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <input type="text" disabled class="form-control" name="t6" value="{{$t6}}">
              </div>
              <label class="col-sm-1 control-label">Frekuensi</label>
              <div class="col-sm-2">
                <input type="text" disabled class="form-control" name="r6" value="{{$r6}}">
              </div>
              <label class="col-sm-1 control-label" style="text-align: left; padding-left: 0px;">x/minggu</label>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <input type="text" disabled class="form-control" name="t7" value="{{$t7}}">
              </div>
              <label class="col-sm-1 control-label">Frekuensi</label>
              <div class="col-sm-2">
                <input type="text" disabled class="form-control" name="r7" value="{{$r7}}">
              </div>
              <label class="col-sm-1 control-label" style="text-align: left; padding-left: 0px;">x/minggu</label>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <input type="text" disabled class="form-control" name="t8" value="{{$t8}}">
              </div>
              <label class="col-sm-1 control-label">Frekuensi</label>
              <div class="col-sm-2">
                <input type="text" disabled class="form-control" name="r8" value="{{$r8}}">
              </div>
              <label class="col-sm-1 control-label" style="text-align: left; padding-left: 0px;">x/minggu</label>
            </div>
            <div class="form-group">
