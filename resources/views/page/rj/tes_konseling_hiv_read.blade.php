            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <label class="col-lg-1 control-label">Kapan</label>
                  <div class="col-lg-3">
                    <input type="text" class="form-control" name="waktu_trm" disabled {{$waktu_trm}}>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-2">
                    <input type="text" class="form-control" name="ktr_lainnya" disabled {{$ktr_lainnya}}>
                  </div>
                  <label class="col-lg-1 control-label">Kapan</label>
                  <div class="col-lg-3">
                    <input type="text" class="form-control" name="waktu_ktr_lainnya" disabled {{$waktu_ktr_lainnya}}>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-3">
                    <input type="text" class="form-control" name="tt_hiv" disabled {{$tt_hiv}}>
                  </div>
                  <label class="col-lg-1 control-label">Kapan</label>
                  <div class="col-lg-3">
                    <input type="text" class="form-control" name="wt_hiv" disabled {{$wt_hiv}}>
                  </div>
                </div>
                <div class="form-group">
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <label class="col-lg-1 control-label">Dimana</label>
                  <div class="col-lg-3">
                    <input type="text" class="form-control" name="tt_hiv2" disabled {{$tt_hiv2}}>
                  </div>
                  <label class="col-lg-1 control-label">Kapan</label>
                  <div class="col-lg-3">
                    <input type="text" class="form-control" name="wt_hiv2" disabled {{$wt_hiv2}}>
                  </div>
                </div>
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-2">
                    <div class="radio">
                      <label>
                        <input type="radio" name="r2" value="0" disabled value="{{$r2 == 0 ? 'checked' : ''}}">
                        Non Reaktif
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="r2" value="1" disabled value="{{$r2 == 1 ? 'checked' : ''}}">
                        Reaktif
                      </label>
                    </div>
                  </div>
                      ...
                      <div class="col-lg-10">
                        ...
                        <div class="radio">
                          <label>
                            ...
                            6. Lain-lain
                            <input type="text" class="form-control" name="ksl_lainnya" disabled {{$ksl_lainnya}}>
                          </label>
                        </div>
                      </div>
                    </div>                      
