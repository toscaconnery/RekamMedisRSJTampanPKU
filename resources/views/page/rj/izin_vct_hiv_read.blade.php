          ...
          <table class="table table-striped table-advance table-hover">
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="btn-group">
                    <a class="btn btn-primary" href="{{url('')}}/rj_izinvct_pdf">PDF</a>
          ...
          <section class="panel">
            ...
            <div class="panel-body">
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" name="pemberi_izin" disabled value="{{$pemberi_izin}}">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">Hubungan Dengan Klien</label>
                <div class="col-lg-2">
                  <select class="form-control input-sm m-bot15" name="hubungan" disabled="">
