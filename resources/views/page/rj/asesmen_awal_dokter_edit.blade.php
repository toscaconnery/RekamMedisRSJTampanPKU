            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="riwayat_penyakit_sekarang" value="{{$riwayat_penyakit_sekarang}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Riwayat Penyakit Dahulu (gangguan kejiwaan) </label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="riwayat_penyakit_dahulu" value="{{$riwayat_penyakit_dahulu}}">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-lg-2">
                    <div class="radio">
                      <label>
                        <input type="radio" name="riwayat_napza" value="0" {{$riwayat_napza == 0 ? 'checked' : ''}}>
                        Tidak ada
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="riwayat_napza" value="1" {{$riwayat_napza == 1 ? 'checked' : ''}}>
                        Ada
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="riwayat_pendidikan" value="{{$riwayat_pendidikan}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Riwayat Pekerjaan </label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="riwayat_pekerjaan" value="{{$riwayat_pekerjaan}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Riwayat Perkawinan </label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="riwayat_perkawinan" value="{{$riwayat_perkawinan}}">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-lg-6">
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="penyakit_1" {{isset($riwayat_penyakit_lainnya[1]) ? 'checked' : ''}}>
                        Hipertensi
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="penyakit_2" {{isset($riwayat_penyakit_lainnya[2]) ? 'checked' : ''}}>
                        Liver
                      </label>
                    </div>
                    ...
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="penyakit_3" {{isset($riwayat_penyakit_lainnya[3]) ? 'checked' : ''}}>
                        Diabetes
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="penyakit_4" {{isset($riwayat_penyakit_lainnya[4]) ? 'checked' : ''}}>
                        Cancer
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="penyakit_5" {{isset($riwayat_penyakit_lainnya[5]) ? 'checked' : ''}}>
                        Jantung
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="penyakit_6" {{isset($riwayat_penyakit_lainnya[6]) ? 'checked' : ''}}>
                        TBC
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="penyakit_7" {{isset($riwayat_penyakit_lainnya[7]) ? 'checked' : ''}}>
                        Stroke
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="penyakit_8" {{isset($riwayat_penyakit_lainnya[8]) ? 'checked' : ''}}>
                        Glaukoma
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="penyakit_9" {{isset($riwayat_penyakit_lainnya[9]) ? 'checked' : ''}}>
                        Dialysis
                      </label>
                    </div>
                    ...
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="penyakit_10" {{isset($riwayat_penyakit_lainnya[10]) ? 'checked' : ''}}>
                        STD
                      </label>
                    </div>
                    ...
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="penyakit_11" {{isset($riwayat_penyakit_lainnya[11]) ? 'checked' : ''}}>
                        Asthma
                      </label>
                    </div>
                    ...
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="penyakit_12" {{isset($riwayat_penyakit_lainnya[12]) ? 'checked' : ''}}>
                        Perdarahan
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="penyakit_13" {{isset($riwayat_penyakit_lainnya[13]) ? 'checked' : ''}}>
                        Kejang
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="penyakit_14" {{isset($riwayat_penyakit_lainnya[14]) ? 'checked' : ''}}>
                        Lainnya 
                      </label>
                    </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-2">
                    <div class="radio">
                      <label>
                        <input type="radio" name="riwayat_operasi" value="0" {{$riwayat_operasi == 0 ? 'checked' : ''}}>
                        Tidak
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="riwayat_operasi" value="1" {{$riwayat_operasi == 1 ? 'checked' : ''}}>
                        Ya
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-2">
                    <div class="radio">
                      <label>
                        <input type="radio" name="riwayat_tranfusi" value="0" {{$riwayat_tranfusi == 0 ? 'checked' : ''}}>
                        Tidak
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="riwayat_tranfusi" value="1" {{$riwayat_tranfusi == 1 ? 'checked' : ''}}>
                        Ya
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-2">
                    <div class="radio">
                      <label>
                        <input type="radio" name="reaksi_tranfusi" value="0" {{$reaksi_tranfusi == 0 ? 'checked' : ''}}>
                        Tidak
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="reaksi_tranfusi" value="1" {{$reaksi_tranfusi == 1 ? 'checked' : ''}}>
                        Ya
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="reaksi_timbul" value="{{$reaksi_timbul}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Riwayat Penyakit dalam keluarga  </label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="riwayat_penyakit_dalam_keluarga" value="{{$riwayat_penyakit_dalam_keluarga}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Riwayat Pengobatan </label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="riwayat_pengobatan" value="{{$riwayat_pengobatan}}">
                  </div>
                </div>
                <div class="form-group">
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr id="obat_{{$o['id_data']}}">
                    <td>{{$idx++}}</td>
                    <td><input type="text" class="form-control" value="{{$o['nama_obat']}}" name="nama_obat_{{$o['id_data']}}"></td>
                    <td><input type="text" class="form-control" value="{{$o['dibawa']}}" name="dibawa_{{$o['id_data']}}"></td>
                    <td><input type="text" class="form-control" value="{{$o['jumlah']}}" name="jumlah_{{$o['id_data']}}"></td>
                    <td><input type="text" class="form-control" value="{{$o['tidak_dibawa']}}" name="tidak_dibawa_{{$o['id_data']}}"></td>
                    <td><input type="text" class="form-control" value="{{$o['keterangan']}}" name="keterangan_{{$o['id_data']}}"></td>
                    <td>
                      <div class="btn-group">
                        <div class="btn-group"><button class="btn btn-default tombol_hapus" type="button" id="tombol_hapus_{{$o['id_data']}}"><i class="icon_close_alt2"></i></button></div>
                      </div>
                    </td>
                  </tr>
                  @endforeach
                  <tr id="last_row_obat">
                    <input type="hidden" name="jumlah_form_obat" id="jumlah_form_obat" value="0">
                    <input type="hidden" name="previous_data" value="{{$previous_data}}">
                    <input type="hidden" name="idx" id="idx" value="{{$idx - 1}}">
                    <td>#</td>
                    <td colspan="6">
                      <div class="btn-group">
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="penampilan" value="{{$penampilan}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Kesadaran</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="kesadaran_psikiatri" value="{{$kesadaran_psikiatri}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Orientasi</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="orientasi" value="{{$orientasi}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Sikap & Tingkah laku </label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="sikap" value="{{$sikap}}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="proses_pikir" value="{{$proses_pikir}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Bentuk Pikir </label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="bentuk_pikir" value="{{$bentuk_pikir}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Isi Pikir </label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="isi_pikir" value="{{$isi_pikir}}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="mood" value="{{$mood}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Afek </label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="afek" value="{{$afek}}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="halusinasi" value="{{$halusinasi}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Ilusi </label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="ilusi" value="{{$ilusi}}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="konsentrasi" value="{{$konsentrasi}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Daya Ingat  </label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="ingat" value="{{$ingat}}">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="impuls" value="{{$impuls}}">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="tilikan" value="{{$tilikan}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Taraf dapat dipercaya  </label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="dipercaya" value="{{$dipercaya}}">
                  </div>
                </div>
              </div>
            </section>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="meningeal" value="{{$meningeal}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Hasil Pemeriksaan Nervus Cranialis</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="nervus" value="{{$nervus}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Pemeriksaan Sistem Motorik</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="motorik" value="{{$motorik}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Koordinasi Gait Keseimbangan (fungsi cerebellum)</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="cerebellum" value="{{$cerebellum}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Vegetatif </label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="vegetatif" value="{{$vegetatif}}">
                  </div>
                </div>
              </div>
            </section>
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-lg-3">
                    <div class="radio">
                      <label>
                        <input type="radio" name="gaduh_gelisah" value="1" {{$gaduh_gelisah == 1 ? 'checked' : ''}}>
                        Tidak ada - definisi tidak dipenuhi
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="gaduh_gelisah" value="2" {{$gaduh_gelisah == 2 ? 'checked' : ''}}>
                        Minimal – patologis diragukan
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="gaduh_gelisah" value="3" {{$gaduh_gelisah == 3 ? 'checked' : ''}}>
                  ...
                  <div class="col-lg-3">
                    <div class="radio">
                      <label>
                        <input type="radio" name="ketidakoperatifan" value="1" {{$ketidakoperatifan == 1 ? 'checked' : ''}}>
                        Tidak ada - definisi tidak dipenuhi
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="ketidakoperatifan" value="2" {{$ketidakoperatifan == 2 ? 'checked' : ''}}>
                        Minimal – patologis diragukan
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="ketidakoperatifan" value="3" {{$ketidakoperatifan == 3 ? 'checked' : ''}}>
                    ...
                    <div class="radio">
                      <label>
                        <input type="radio" name="ketidakoperatifan" value="4" {{$ketidakoperatifan == 4 ? 'checked' : ''}}>
                    ...
                    <div class="radio">
                      <label>
                        <input type="radio" name="ketidakoperatifan" value="5" {{$ketidakoperatifan == 5 ? 'checked' : ''}}>
                    ...
                    <div class="radio">
                      <label>
                        <input type="radio" name="ketidakoperatifan" value="6" {{$ketidakoperatifan == 6 ? 'checked' : ''}}>
                    ...
                    <div class="radio">
                      <label>
                        <input type="radio" name="ketidakoperatifan" value="7" {{$ketidakoperatifan == 7 ? 'checked' : ''}}>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-3">
                    <div class="radio">
                      <label>
                        <input type="radio" name="permusuhan" value="1" {{$permusuhan == 1 ? 'checked' : ''}}>
                        Tidak ada - definisi tidak dipenuhi
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="permusuhan" value="2" {{$permusuhan == 2 ? 'checked' : ''}}>
                        Minimal – patologis diragukan
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="permusuhan" value="3" {{$permusuhan == 3 ? 'checked' : ''}}>
                        Ringan – melampiaskan kemarahan secara tidak langsung atau ditahan
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="permusuhan" value="4" {{$permusuhan == 4 ? 'checked' : ''}}>
                        Sedang – sikap bermusuhan yang nyata
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="permusuhan" value="5" {{$permusuhan == 5 ? 'checked' : ''}}>
                        Agak berat – pasien sangat mudah marah dan kadang-kadang memaki dengan kata-kata kasar atau mengancam
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="permusuhan" value="6" {{$permusuhan == 6 ? 'checked' : ''}}>
                    ...
                    <div class="radio">
                      <label>
                        <input type="radio" name="permusuhan" value="7" {{$permusuhan == 7 ? 'checked' : ''}}>
                  ...
                  <div class="col-lg-3">
                    <div class="radio">
                      <label>
                        <input type="radio" name="pengendalian_impuls" value="1" {{$pengendalian_impuls == 1 ? 'checked' : ''}}>
                        Tidak ada - definisi tidak dipenuhi
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="pengendalian_impuls" value="2" {{$pengendalian_impuls == 2 ? 'checked' : ''}}>
                        Minimal – patologis diragukan
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="pengendalian_impuls" value="3" {{$pengendalian_impuls == 3 ? 'checked' : ''}}>
                    ...
                    <div class="radio">
                      <label>
                        <input type="radio" name="pengendalian_impuls" value="4" {{$pengendalian_impuls == 4 ? 'checked' : ''}}>
                    ...
                    <div class="radio">
                      <label>
                        <input type="radio" name="pengendalian_impuls" value="5" {{$pengendalian_impuls == 5 ? 'checked' : ''}}>
                    ...
                    <div class="radio">
                      <label>
                        <input type="radio" name="pengendalian_impuls" value="6" {{$pengendalian_impuls == 6 ? 'checked' : ''}}>
                    ...
                    <div class="radio">
                      <label>
                        <input type="radio" name="pengendalian_impuls" value="7" {{$pengendalian_impuls == 7 ? 'checked' : ''}}>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-3">
                    <div class="radio">
                      <label>
                        <input type="radio" name="ketegangan" value="1" {{$ketegangan == 1 ? 'checked' : ''}}>
                        Tidak ada - definisi tidak dipenuhi
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="ketegangan" value="2" {{$ketegangan == 2 ? 'checked' : ''}}>
                        Minimal – patologis diragukan
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="ketegangan" value="3" {{$ketegangan == 3 ? 'checked' : ''}}>
                    ...
                    <div class="radio">
                      <label>
                        <input type="radio" name="ketegangan" value="4" {{$ketegangan == 4 ? 'checked' : ''}}>
                    ...
                    <div class="radio">
                      <label>
                        <input type="radio" name="ketegangan" value="5" {{$ketegangan == 5 ? 'checked' : ''}}>
                    ...
                    <div class="radio">
                      <label>
                        <input type="radio" name="ketegangan" value="6" {{$ketegangan == 6 ? 'checked' : ''}}>
                        Berat – Ketegangan berat, taraf interaksi terganggu. Misalnya terus-menerus bergerak, tidak dapat tetap duduk, hiperventilasi
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="ketegangan" value="7" {{$ketegangan == 7 ? 'checked' : ''}}>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" autocomplete="off" onkeydown="return false" class="form-control sandbox-container" name="tanggal_pemeriksaan" value="{{$tanggal_pemeriksaan}}">
                  </div>
                </div>
                <div class="form-group">
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="axis1" value="{{$axis1}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Axis 2</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="axis2" value="{{$axis2}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Axies 3</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="axis3" value="{{$axis3}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Axis 4</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="axis4" value="{{$axis4}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Axis 5</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="axis5" value="{{$axis5}}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="utama" value="{{$utama}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Diagnosis Sekunder</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="sekunder" value="{{$sekunder}}">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="tindakan_terapi" value="{{$tindakan_terapi}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Daftar Masalah</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="daftar_masalah" value="{{$daftar_masalah}}">
                  </div>
                </div>
              </div>
            </section>
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <div class="radio">
                      <label>
                        <input type="radio" name="tindak_lanjut" value="1" {{$tindak_lanjut == 1 ? 'checked' : ''}}>
                        Pulang
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="tindak_lanjut" value="2" {{$tindak_lanjut == 2 ? 'checked' : ''}}>
                        Dirawat
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="tindak_lanjut" value="3" {{$tindak_lanjut == 3 ? 'checked' : ''}}>
                        Menolak dirawat
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="tindak_lanjut" value="4" {{$tindak_lanjut == 4 ? 'checked' : ''}}>
                        Dirujuk
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <div class="radio">
                      <label>
                        <input type="radio" name="perlu_dikontrol" value="0" {{$perlu_dikontrol == 0 ? 'checked' : ''}}>
                        Tidak perlu kontrol
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="perlu_dikontrol" value="1" {{$perlu_dikontrol == 1 ? 'checked' : ''}}>
                        Perlu Kontrol
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="indikasi_rawat_inap" value="{{$indikasi_rawat_inap}}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <div class="radio">
                      <label>
                        <input type="radio" name="alasan_menolak" value="1" {{$alasan_menolak == 1 ? 'checked' : ''}}>
                        Masalah biaya
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="alasan_menolak" value="2" {{$alasan_menolak == 2 ? 'checked' : ''}}>
                        Masalah lokasi rumah
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="alasan_menolak" value="3" {{$alasan_menolak == 3 ? 'checked' : ''}}>
                        Kondisi pasien
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="alasan_menolak" value="4" {{$alasan_menolak == 4 ? 'checked' : ''}}>
                        Lainnya
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="alasan_lainnya" value="{{$alasan_lainnya}}">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <div class="radio">
                      <label>
                        <input type="radio" name="alasan_dirujuk" value="1" {{$alasan_dirujuk == 1 ? 'checked' : ''}}>
                        Tempat Penuh
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="alasan_dirujuk" value="2" {{$alasan_dirujuk == 2 ? 'checked' : ''}}>
                        Perlu Fasilitas Lebih
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="alasan_dirujuk" value="3" {{$alasan_dirujuk == 3 ? 'checked' : ''}}>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <label class="checkbox-inline">
                      <input type="checkbox" name="kesadaran_1" {{isset($kesadaran[1]) ? 'checked' : ''}}> Compos Mentis
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" name="kesadaran_2" {{isset($kesadaran[2]) ? 'checked' : ''}}> Apatis
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" name="kesadaran_3" {{isset($kesadaran[3]) ? 'checked' : ''}}> Delirium
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" name="kesadaran_4" {{isset($kesadaran[4]) ? 'checked' : ''}}> Sopor
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" name="kesadaran_5" {{isset($kesadaran[5]) ? 'checked' : ''}}> Koma
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" name="kesadaran_6" {{isset($kesadaran[6]) ? 'checked' : ''}}> GCS
                    </label>
                    <label class="checkbox-inline">
                      <input type="checkbox" name="kesadaran_7" {{isset($kesadaran[7]) ? 'checked' : ''}}> Lain-lain
                    </label>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Sebutkan</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="kesadaran_lainnya" value="{{$kesadaran_lainnya}}">
                  </div>
                </div>
