            ...
            <table class="table table-striped table-advance table-hover">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                      <a class="btn btn-primary" href="{{url('')}}/ri_spd_pdf">PDF</a>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="pendidikan" disabled="" value="{{$pendidikan}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Pekerjaan</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="pekerjaan" disabled="" value="{{$pekerjaan}}">
                  </div>
                </div>
                <div class="form-group">
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="nama_pj" disabled="" value="{{$nama_pj}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Alamat</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="alamat_pj" disabled="" value="{{$alamat_pj}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">No.Telp/HP</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="no_telp_pj" disabled="" value="{{$no_telp_pj}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label"></label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="no_telp_pj2" disabled="" value="{{$no_telp_pj2}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Ruang/Kelas</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="ruang" disabled="" value="{{$ruang}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Cara Bayar</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="cara_bayar" disabled="" value="{{$cara_bayar}}">
                  </div>
                </div>
              </div>
            </section>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea class="form-control" rows="5" style="resize: none;" name="sebab_utama_dirawat" readonly>{{$sebab_utama_dirawat}}></textarea>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea class="form-control" rows="5" style="resize: none;" name="diagnosa" readonly>{{$diagnosa}}></textarea>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="gaf" disabled="" value="{{$gaf}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">PANSS - EC</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="panss_ec" disabled="" value="{{$panss_ec}}">
                  </div>
                </div>
              </div>
            </section>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea class="form-control" rows="5" style="resize: none;" name="terapi" readonly>{{$terapi}}></textarea>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="ruang_masuk_rs" disabled="" value="{{$ruang_masuk_rs}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Kelas</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="kelas_masuk_rs" disabled="" value="{{$kelas_masuk_rs}}">
                  </div>
                </div>
              </div>
            </section>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="dokter_igd_klinik" disabled="" value="{{$dokter_igd_klinik}}">
                  </div>
                </div>
              </div>
            </section>
