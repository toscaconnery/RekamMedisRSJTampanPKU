            ...
            <table class="table table-striped table-advance table-hover">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                      <a class="btn btn-primary" href="{{url('')}}/ri_rencanaklien5_pdf">PDF</a>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        TUK: <br>
                        <input type="text" disabled class="form-control" name="t1b" value="{{$t1b}}">
                        1. Klien dapat membina hubungan saling percaya dengan perawat
                      </td>
                      <td>
                        1. Dalam <input type="text" disabled name="k1" value="{{$k1}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menunjukkan tanda-tanda percaya kepada perawat:<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        2. Dalam <input type="text" disabled name="k2" value="{{$k2}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyebutkan:<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        3.1. Dalam <input type="text" disabled name="t3" value="{{$t3}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyebutkan frekuensi menjaga perawatan diri:<br>
                        <ul>
                        ...
                        3.2. Dalam <input type="text" disabled name="t3b" value="{{$t3b}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menjelaskan<br>
                    ...
                    <tr>
                      ...
                      <td>
                        4. Dalam <input type="text" disabled name="k4" value="{{$k4}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien mempraktekkan perawatan diri dengan dibantu oleh perawat:<br>
                        <ul>
                          <li>Mandi</li>
                          <li>Gosok gigi</li>
                          <li>Keramas</li>
                    ...
                    <tr>
                      ...
                      <td>
                        5. Dalam <input type="text" disabled name="k5" value="{{$k5}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien melaksanakan praktek perawatan diri secara mandiri:<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        6.1. Dalam <input type="text" disabled name="k6" value="{{$k6}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi keluarga menjelaskan cara-cara membantu klien dalam memenuhi kebutuhan perawatan dirinya<br>
                        <br>
                        6.2. Dalam <input type="text" disabled name="k6b" value="{{$k6b}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi keluarga menyiapkan sarana perawatan diri klien: sabun mandi, pasta gigi, sikat gigi, shampoo, handuk, pakaian bersih, dan alat berhias<br>
                        <br>
                    ...
                    <tr>
                      ...
                      <td>
                        7.1. Setelah <input type="text" disabled name="k7" value="{{$k7}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi keluarga dapat menjelaskan tentang:<br>
                        <ul>
                        ...
                        7.2. Setelah <input type="text" disabled name="k7b" value="{{$k7b}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi keluarga dapat mempraktekkan cara merawat klien waham.
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        8.1. Setelah <input type="text" disabled name="k8" value="{{$k8}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyebutkan:<br>
                        <ul>
                          <li>Manfaat minum obat</li>
                          <li>Kerugian tidak minum obat</li>
                          <li>Nama, warna, dosis, efek terapi dan efek samping obat</li>
                        </ul>
                        8.2. Setelah <input type="text" disabled name="k8b" value="{{$k8b}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien mendemonstrasikan penggunaan obat dengan benar<br>
                        8.3. Setelah <input type="text" disabled name="k8c" value="{{$k8c}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyebutkan akibat berhenti minum obat tanpa konsultasi dokter
                      </td>
                      <td>
