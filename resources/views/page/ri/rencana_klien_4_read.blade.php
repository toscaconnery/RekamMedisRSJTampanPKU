                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        1. Setelah <input type="text" disabled name="k1" value="{{$k1}}" style="width: 6em; display: inline;" class="form-control"> x interaksi klien menunjukkan tanda-tanda percaya kepada / terhadap perawat:<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        2. Setelah <input type="text" disabled name="k2" value="{{$k2}}" style="width: 6em; display: inline;" class="form-control"> x interaksi klien dapat menyebutkan minimal satu penyebab menarik diri dari:<br>
                        <ul>
                          <li>diri sendiri</li>
                          <li>orang lain</li>
                          <li>lingkungan</li>
                    ...
                    <tr>
                      ...
                      <td>
                        3. Setelah <input type="text" disabled name="k3" value="{{$k3}}" style="width: 6em; display: inline;" class="form-control"> x interaksi dengan klien dapat menyebutkan keuntungan berhubungan sosial, misalnya:<br>
                        <ul>
                          <li>Banyak teman</li>
                    ...
                    <tr>
                      ...
                      <td>
                        4. Setelah <input type="text" disabled name="k4" value="{{$k4}}" style="width: 6em; display: inline;" class="form-control"> x interaksi klien dapat melakukan hubungan sosial secara bertahap dengan:<br>
                        <ul>
                          <li>Perawat</li>
                          <li>Perawat lain</li>
                          <li>Klien lain</li>
                    ...
                    <tr>
                      ...
                      <td>
                        5. Setelah <input type="text" disabled name="k5" value="{{$k5}}" style="width: 6em; display: inline;" class="form-control"> x interaksi klien dapat menjelaskan perasaannya setelah berhubungan sosial dengan:<br>
                        <ul>
                          <li>Orang lain</li>
                          <li>Kelompok</li>
                        </ul>
                    ...
                    <tr>
                      ...
                      <td>
                        6.1. Setelah <input type="text" disabled name="k6" value="{{$k6}}" style="width: 6em; display: inline;" class="form-control"> x pertemuan keluarga dapat menjelaskan tentang:<br>
                        <ul>
                        ...
                        6.2. Setelah <input type="text" disabled name="k6b" value="{{$k6b}}" style="width: 6em; display: inline;" class="form-control"> x pertemuan keluarga dapat mempraktekkan cara merawat klien menarik diri.
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        7.1. Setelah <input type="text" disabled name="k7" value="{{$k7}}" style="width: 6em; display: inline;" class="form-control"> x interaksi klien menyebutkan:<br>
                        <ul>
                          <li>Manfaat minum obat</li>
                          <li>Kerugian tidak minum obat</li>
                          <li>Nama, warna, dosis, efek terapi dan efek samping obat</li>
                        </ul>
                        7.2. Setelah <input type="text" disabled name="k7b" value="{{$k7b}}" style="width: 6em; display: inline;" class="form-control"> x interaksi klien mendemonstrasikan penggunaan obat dengan benar<br>
                        7.3. Setelah <input type="text" disabled name="k7c" value="{{$k7c}}" style="width: 6em; display: inline;" class="form-control"> x interaksi klien menyebutkan akibat berhenti minum obat tanpa konsultasi dokter
                      </td>
                      <td>
