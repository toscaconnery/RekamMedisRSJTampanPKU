          ...
          <table class="table table-striped table-advance table-hover">
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="btn-group">
                    <a class="btn btn-info" href="{{url('')}}/ri_asesmen_awal_keperawatan_napza">Isi</a>
                    <a class="btn btn-primary" href="{{url('')}}/ri_asesmen_awal_keperawatan_napza_read">Lihat</a>
                    <a class="btn btn-success" href="{{url('')}}/ri_asesmen_awal_keperawatan_napza_edit">Edit</i></a>
                    <a class="btn btn-danger" href="#">Hapus</a>
                  </div>
                </td>
                <td>
                  <a class="btn btn-default" href="{{url('')}}/ri_napza_pdf">Cetak</a>
                </td>
              </tr>
            </tbody>
          </table>
