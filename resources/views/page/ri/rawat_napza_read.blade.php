          ...
          <section class="panel">
            ...
            <div class="panel-body">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" id="dp1" class="form-control" name="tanggal_pengkajian" disabled="" value="{{$tanggal_pengkajian}}" >
                </div>
              </div>
              <div class="form-group">
                <label class="col-lg-2 control-label"> Sumber Informasi</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="sumber_informasi" disabled="" value="{{$sumber_informasi}}">
                </div>
              </div>
              <div class="form-group">
                <label class="col-lg-2 control-label"> Tanggal Dirawat</label>
                <div class="col-sm-10">
                  <input type="text" id="dp2" class="form-control" name="tanggal_dirawat" disabled="" value="{{$tanggal_dirawat}}">
                </div>
              </div>
              <div class="form-group">
          ...
          <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="col-lg-6">
                  ...
                  <div class="checkbox">
                    <label>
                      ...
                      Lain-lain
                      <input type="text" class="form-control" name="alasan_masuk_lainnya" placeholder="sebutkan.. "  disabled="" value="{{$alasan_masuk_lainnya}}">
                    </label>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="jenis_zat" disabled="" value="{{$jenis_zat}}">
                </div>
              </div>
              <div class="form-group">
                <label class="col-lg-2 control-label"> Cara Pemakaian</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="cara_pemakaian" disabled="" value="{{$cara_pemakaian}}">
                </div>
              </div>
            </div>
          </section>
          ...
          <section class="panel">
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="keterangan_komplikasi" disabled="" value="{{$keterangan_komplikasi}}">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="problema_masyarakat_lainnya" disabled="" value="{{$problema_masyarakat_lainnya}}">
                </div>
              </div>
              <div class="form-group">
                <label class="col-lg-2 control-label"> Dirawat di RS Jiwa Diagnosis Medis</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="dirawat_diagnosis_medis" disabled="" value="{{$dirawat_diagnosis_medis}}">
                </div>
              </div>
              <div class="form-group">
          ...
          <section class="panel">
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="masalah_keperawatan_1" disabled="" value="{{$masalah_keperawatan_1}}">
                </div>
              </div>
            </div>
          </section>
          ...
          <section class="panel">
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                <label class="col-lg-2 control-label"> Masalah Keperawatan</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="masalah_keperawatan_2" disabled="" value="{{$masalah_keperawatan_2}}">
                </div>
              </div>
            </div>
          </section>
          ...
          <section class="panel">
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                <label class="col-lg-2 control-label"> Masalah keperawatan</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="masalah_keperawatan_3" disabled="" value="{{$masalah_keperawatan_3}}">
                </div>
              </div>
            </div>
          </section>
          ...
          <section class="panel">
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                <label class="col-lg-2 control-label"> Sebutkan</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="anggota_keluarga" disabled="" value="{{$anggota_keluarga}}">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-lg-2 control-label"> Sebutkan</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="keterangan_pranikah" disabled="" value="{{$keterangan_pranikah}}">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-lg-2 control-label"> Masalah Keperawatan</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="masalah_keperawatan_4" disabled="" value="{{$masalah_keperawatan_4}}">
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-lg-2 control-label">Sebutkan</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="gambaran_diri_lainnya" disabled="" value="{{$gambaran_diri_lainnya}}">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-lg-2 control-label"> Masalah Keperawatan</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="masalah_keperawatan_5" disabled="" value="{{$masalah_keperawatan_5}}">
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-lg-2 control-label">Sebutkan</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="nilai_keyakinan_lainnya" disabled="" value="{{$nilai_keyakinan_lainnya}}">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-lg-2 control-label">Masalah Keperawatan</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="masalah_keperawatan_6" disabled="" value="{{$masalah_keperawatan_6}}">
                </div>
              </div>
            </div>
          </section>
          ...
          <section class="panel">
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                <label class="col-lg-2 control-label"> Sebutkan</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="adaptif_lainnya" disabled="" value="{{$adaptif_lainnya}}">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-lg-2 control-label"> Sebutkan</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="maladaptif_lainnya" disabled="" value="{{$maladaptif_lainnya}}">
                </div>
              </div>
              <div class="form-group">
                <label class="col-lg-2 control-label"> Masalah Keperawatan</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="masalah_keperawatan_7" disabled="" value="{{$masalah_keperawatan_7}}">
                </div>
              </div>
            </div>
          </section>
          ...
          <section class="panel">
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                <label class="col-lg-2 control-label"> Sebutkan</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="pengetahuan_kurang_lainnya" disabled="" value="{{$pengetahuan_kurang_lainnya}}">
                </div>
              </div>
              <div class="form-group">
                <label class="col-lg-2 control-label"> Masalah keperawatan</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="masalah_keperawatan_8" disabled="" value="{{$masalah_keperawatan_8}}">
                </div>
              </div>
            </div>
          </section>
          ...
          <section class="panel">
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="terapi_medis" disabled="" value="{{$terapi_medis}}">
                </div>
              </div>
            </div>
          </section>
          ...
          <section class="panel">
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                <label class="col-lg-2 control-label"> Sebutkan</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="masalah_keperawatan_lainnya" disabled="" value="{{$masalah_keperawatan_lainnya}}">
                </div>
              </div>
            </div>
          </section>
