...
<body>
  ...
  <section id="main-content">
    <section class="wrapper">
      ...
      <div class="row">
        <div class="col-lg-12">
          <form class="form-horizontal" method="post" action="ri_rencana_klien_5">
            {{ csrf_field() }}
            <section class="panel">
              <header class="panel-heading">
                Rencana Tindakan
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        TUK: <br>
                        <input type="text" class="form-control" name="t1b">
                        1. Klien dapat membina hubungan saling percaya dengan perawat
                      </td>
                      <td>
                        1. Dalam <input type="text" name="k1" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menunjukkan tanda-tanda percaya kepada perawat:<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        2. Dalam <input type="text" name="k2" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyebutkan:<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        3.1. Dalam <input type="text" name="t3" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyebutkan frekuensi menjaga perawatan diri:<br>
                        <ul>
                        ...
                        3.2. Dalam <input type="text" name="t3b" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menjelaskan<br>
                    ...
                    <tr>
                      ...
                      <td>
                        4. Dalam <input type="text" name="k4" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien mempraktekkan perawatan diri dengan dibantu oleh perawat:<br>
                        <ul>
                          <li>Mandi</li>
                          <li>Gosok gigi</li>
                          <li>Keramas</li>
                    ...
                    <tr>
                      ...
                      <td>
                        5. Dalam <input type="text" name="k5" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien melaksanakan praktek perawatan diri secara mandiri:<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        6.1. Dalam <input type="text" name="k6" style="width: 6em; display: inline;" class="form-control"> kali interaksi keluarga menjelaskan cara-cara membantu klien dalam memenuhi kebutuhan perawatan dirinya<br>
                        <br>
                        6.2. Dalam <input type="text" name="k6b" style="width: 6em; display: inline;" class="form-control"> kali interaksi keluarga menyiapkan sarana perawatan diri klien: sabun mandi, pasta gigi, sikat gigi, shampoo, handuk, pakaian bersih, dan alat berhias<br>
                        <br>
                    ...
                    <tr>
                      ...
                      <td>
                        7.1. Setelah <input type="text" name="k7" style="width: 6em; display: inline;" class="form-control"> kali interaksi keluarga dapat menjelaskan tentang:<br>
                        <ul>
                        ...
                        7.2. Setelah <input type="text" name="k7b" style="width: 6em; display: inline;" class="form-control"> kali interaksi keluarga dapat mempraktekkan cara merawat klien waham.
                      </td>
                      <td>
                    ...
                    <tr>
                      <td style="text-align:center;"><input type="text" autocomplete="off" onkeydown="return false" class="form-control sandbox-container" name="tanggal_8"></td>
                      <td><input type="text" class="form-control" name="nodx_8"></td>
                      <td><input type="text" class="form-control" name="dxk_8"></td>
                      <td>
                        8. Klien dapat memanfaatkan obat dengan baik
                      </td>
                      <td>
                        8.1. Setelah <input type="text" name="k8" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyebutkan:<br>
                        <ul>
                          <li>Manfaat minum obat</li>
                          <li>Kerugian tidak minum obat</li>
                          <li>Nama, warna, dosis, efek terapi dan efek samping obat</li>
                        </ul>
                        8.2. Setelah <input type="text" name="k8b" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien mendemonstrasikan penggunaan obat dengan benar<br>
                        8.3. Setelah <input type="text" name="k8c" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyebutkan akibat berhenti minum obat tanpa konsultasi dokter
                      </td>
                      <td>
