        ...
        <section class="panel">
          ...
          <div class="panel-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="text" id="dp1" class="form-control" name="tanggal_masuk">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Tanggal Keluar RS</label>
              <div class="col-sm-2">
                <input type="text" id="dp2" class="form-control" name="tanggal_keluar">
              </div>
            </div>
            <div class="form-group">
        ...
        <section class="panel">
          ...
          <div class="panel-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="text" id="dp3" class="form-control" name="tanggal_kontrol">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                <input type="text" id="dp4" class="form-control" name="tanggal_pengambilan">
              </div>
            </div>
