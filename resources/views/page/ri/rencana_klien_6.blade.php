...
<body>
  ...
  <section id="main-content">
    <section class="wrapper">
      ...
      <div class="row">
        <div class="col-lg-12">
          <form class="form-horizontal" method="post" action="ri_rencana_klien_6">
            {{ csrf_field() }}
            <section class="panel">
              ...
              <div class="panel-body">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="text-align:center;"><input type="text" autocomplete="off" onkeydown="return false" class="form-control sandbox-container" name="tanggal_2b"></td>
                      <td><input type="text" class="form-control" name="nodx_2b"></td>
                      <td><input type="text" class="form-control" name="dxk_2b"></td>
                      <td></td>
                      <td>
                        2. Setelah <input type="text" name="k2b" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyatakan perasaan dan responnya saat mengalami halusinasi<br>
                        <ul>
                          <li>Marah</li>
                          <li>Takut</li>
                          <li>Sedih</li>
                    ...
                    <tr>
                      ...
                      <td>
                        3.1. Setelah <input type="text" name="k3" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyebutkan tindakan yang biasanya dilakukan untuk mengendalikan halusinasinya<br>
                        <br>
                        
                        3.2. Setelah <input type="text" name="k3b" style="width: 6em; display: inline;" class="form-control"> kali interkasi klien menyebutkan cara baru mengontrol halusinasi<br>
                        <br>

                        3.3. Setelah <input type="text" name="k3c" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien dapat memilih dan memperagakan cara mengatasi halusinasi (dengar/lihat/penghidu/raba/kecap)<br>
                        <br>

                        3.4. Setelah <input type="text" name="k3d" style="width: 6em; display: inline;" class="form-control"> kali interkasi klien melaksanakan cara yang telah dipilih untuk mengendalikan halusinasinya<br>
                        <br>

                        3.5. Setelah <input type="text" name="k3e" style="width: 6em; display: inline;" class="form-control"> kali pertemuan klien mengikuti terapi aktivitas kelompok
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        4.1. Setelah <input type="text" name="k4" style="width: 6em; display: inline;" class="form-control"> kali pertemuan keluarga, keluarga menyatakan setuju untuk mengikuti pertemuan dengan perawat<br>
                        <br>
                        4.2. Setelah <input type="text" name="k4b" style="width: 6em; display: inline;" class="form-control"> kali Interkasi keluarga menyebutkan pengertian, tanda dan gejala, proses terjadinya halusinasi dan tindakan untuk mengendalikan halusinasi
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        5.1. Setelah <input type="text" name="k5" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyebutkan:<br>
                        <ul>
                          <li>Manfaat minum obat</li>
                          <li>Kerugian tidak minum obat</li>
                          <li>Nama, warna, dosis, efek terapi dan efek samping obat</li>
                        </ul>
                        5.2. Setelah <input type="text" name="k5b" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien mendemonstrasikan penggunaan obat dengan benar<br><br>
                        5.3. Setelah <input type="text" name="k5c" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyebutkan akibat berhenti minum obat tanpa konsultasi dokter 
                      </td>
                      <td>
