                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        2. Setelah <input type="text" disabled name="k2" value="{{$k2}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien dapat dilindungi sampai tidak ada keinginan bunuh diri<br>
                        <ul>
                          <li>Ada kontak mata</li>
                    ...
                    <tr>
                      ...
                      <td>
                        3. Setelah <input type="text" disabled name="k3" value="{{$k3}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyebutkan:<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        4. Setelah <input type="text" disabled name="k4" value="{{$k4}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyebutkan:<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        5. Setelah <input type="text" disabled name="k5" value="{{$k5}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyebutkan:<br>
                        <ul>
