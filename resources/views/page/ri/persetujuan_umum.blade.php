...
<body>
  ...
  <section id="main-content">
    <section class="wrapper">
      ...
      <div class="row">
        <div class="col-lg-12">
          <form class="form-horizontal form-validate" method="post" id="register_form" action="ri_persetujuan_umum">
            {{ csrf_field() }}
            <section class="panel">
                    ...
                    <td colspan="4">
                      <div class="">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="nama_pasien_keluarga">
                          </div>
                        </div>
                      </div>
                    </td>
