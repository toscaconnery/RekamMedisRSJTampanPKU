            ...
            <table class="table table-striped table-advance table-hover">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-default" href="{{url('')}}/ri_pulang_paksa_pdf">Cetak</a>
                  </td>
                </tr>
              </tbody>
            </table>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" disabled class="form-control" name="hubungan_keluarga" value="{{$hubungan_keluarga}}">
                  </div>
                </div>
                <div class="form-group">
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Nama</label>
                  <div class="col-sm-8">
                    <input type="text" disabled class="form-control" name="nama_pasien" value="{{$nama_pasien}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Umur</label>
                  <div class="col-sm-8">
                    <input type="text" disabled class="form-control" name="umur_pasien" value="{{$umur_pasien}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Alamat</label>
                  <div class="col-sm-8">
                    <input type="text" disabled class="form-control" name="alamat_pasien" value="{{$alamat_pasien}}">
                  </div>
                </div>
              </div>
            </section>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" disabled class="form-control" name="yang_menyatakan" value="{{$yang_menyatakan}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Saksi Keluarga</label>
                  <div class="col-sm-8">
                    <input type="text" disabled class="form-control" name="saksi_keluarga" value="{{$saksi_keluarga}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Saksi Pemberi Asuhan</label>
                  <div class="col-sm-8">
                    <input type="text" disabled class="form-control" name="saksi_pemberi_asuhan" value="{{$saksi_pemberi_asuhan}}">
                  </div>
                </div>
              </div>
            </section>
