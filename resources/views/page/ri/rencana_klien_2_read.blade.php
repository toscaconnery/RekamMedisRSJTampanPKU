                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        2. Setelah <input type="text" disabled name="k2" value="{{$k2}}" style="width: 4em; display: inline;" class="form-control"> kali interaksi klien menyebutkan:<br>
                        <ul>
