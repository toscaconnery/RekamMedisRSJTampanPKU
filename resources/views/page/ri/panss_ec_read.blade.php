            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="text" autocomplete="off" onkeypress="return false" class="form-control sandbox-container" name="tanggal_pemeriksaan" disabled value="{{$tanggal_pemeriksaan}}">
                  </div>
                </div>
              </div>
            </section>
