...
<body>
  ...
  <section id="main-content">
    <section class="wrapper">
            ...
            <table class="table table-striped table-advance table-hover">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                      <a class="btn btn-info" href="{{url('')}}/ri_transfer_internal">Isi</a>
                      <a class="btn btn-primary" href="{{url('')}}/ri_transfer_internal_read">Lihat</a>
                      <a class="btn btn-success" href="{{url('')}}/ri_transfer_internal_edit">Edit</i></a>
                      <a class="btn btn-danger" href="#">Hapus</a>
                    </div>
                  </td>
                  <td>
                    <a class="btn btn-default" href="{{url('')}}/ri_internal_pdf">Cetak</a>
                  </td>
                </tr>
              </tbody>
            </table>
      ...
      <form class="form-horizontal" method="post" action="ri_transfer_internal_edit">
        {{ csrf_field() }}
        <div class="row">
          <div class="col-lg-6">
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="dokter_konsulen_1" value="{{$dokter_konsulen_1}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-3">Dokter Konsulen 2</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="dokter_konsulen_2" value="{{$dokter_konsulen_2}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-3">Dokter Konsulen 3</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="dokter_konsulen_3" value="{{$dokter_konsulen_3}}">
                  </div>
                </div>
              </div>
            </section>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="ruang_kamar" value="{{$ruang_kamar}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-3">Tgl Pindah</label>
                  <div class="col-sm-3">
                    <input type="text" autocomplete="off" onkeydown="return false" placeholder="Tanggal" class="form-control sandbox-container" name="tanggal_pindah" value="{{$tanggal_pindah}}">
                  </div>
                  <label class="control-label col-sm-3">Jam Pindah</label>
                  <div class="col-sm-3">
                    <input type="time" class="form-control" placeholder="Jam" name="jam_pindah" value="{{$jam_pindah}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-3">Pindah ke ruang/kamar</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="pindah_ke" value="{{$pindah_ke}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-3">Diagnosis Sekarang</label>
                  <div class="col-sm-9">
                    <textarea style="resize: none;" rows="3" class="form-control" name="diagnosis_sekarang">{{$diagnosis_sekarang}}</textarea>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="keadaan_umum" value="{{$keadaan_umum}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Kesadaran</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="kesadaran" value="{{$kesadaran}}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="riwayat_penyakit" value="{{$riwayat_penyakit}}">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="alasan_pindah" value="{{$alasan_pindah}}">
                  </div>
                </div>
              </div>
            </section>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="laboratorium" value="{{$laboratorium}}">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="radiologi" value="{{$radiologi}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">CT scan</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="ct_scan" value="{{$ct_scan}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">USG</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="usg" value="{{$usg}}">
                  </div>
                </div>
              </div>
            </section>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea class="form-control" style="resize: vertical;" rows="3" name="tindakan_medis">{{$tindakan_medis}}</textarea>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea class="form-control" style="resize: vertical;" rows="3" name="infus">{{$infus}}</textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Obat Injeksi</label>
                  <div class="col-sm-8">
                    <input class="tagsinput" style="display: none;" name="obat_injeksi" value="{{$obat_injeksi}}">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea class="form-control" style="resize: vertical;" rows="3" name="lain_lain">{{$lain_lain}}</textarea>
                  </div>
                </div>
              </div>
            </section>
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <div class="radio">
                      <label>
                        <input type="radio" name="kategori" value="0" {{$kategori == '0' ? 'checked' : ''}}>
                        Level 0
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="kategori" value="1" {{$kategori == '1' ? 'checked' : ''}}>
                        Level 1
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="kategori" value="2" {{$kategori == '2' ? 'checked' : ''}}>
                        Level 2
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="kategori" value="3" {{$kategori == '3' ? 'checked' : ''}}>
                        Level 3
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="yang_menyerahkan" value="{{$yang_menyerahkan}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Yang Menerima</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="yang_menerima" value="{{$yang_menerima}}">
                  </div>
                </div>
              </div>
            </section>
