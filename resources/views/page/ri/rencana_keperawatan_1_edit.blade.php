...
<body>
  ...
  <section id="main-content">
    <section class="wrapper">
            ...
            <table class="table table-striped table-advance table-hover">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-default" href="{{url('')}}/ri_rencana1_pdf">Cetak</a>
                  </td>
                </tr>
              </tbody>
            </table>
      ...
      <form class="form-horizontal " method="post" action="ri_rencana_keperawatan_1_edit">
        {{ csrf_field() }}
        <div class="row">
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="ti1_2" {{isset($ti1[2]) ? 'checked' : ''}}>
                        Awasi kondisi pasien dengan ketat
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="ti1_3" {{isset($ti1[3]) ? 'checked' : ''}}>
                        Observasi variatif
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="ti1_4" {{isset($ti1[4]) ? 'checked' : ''}}>
                        Berikan psikofarmaka
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="ti1_5" {{isset($ti1[5]) ? 'checked' : ''}}>
                        Pertimbangkan mengusulkan
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="ti1_6" {{isset($ti1[6]) ? 'checked' : ''}}>
                        ECT jika perlu
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-6">
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="ti2_1" {{isset($ti2[1]) ? 'checked' : ''}}>
                    ...
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="ti2_3" {{isset($ti2[3]) ? 'checked' : ''}}>
                        Tingkatkan harga diri pasien
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="ti2_4" {{isset($ti2[4]) ? 'checked' : ''}}>
                        Kerahkan dukungan sosial
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="ti2_5" {{isset($ti2[5]) ? 'checked' : ''}}>
                        Awasi dengan ketat
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="ti2_6" {{isset($ti2[6]) ? 'checked' : ''}}>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-6">
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="ti3_1" {{isset($ti3[1]) ? 'checked' : ''}}>
                        Dengarkan keluhan pasien
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="ti3_2" {{isset($ti3[2]) ? 'checked' : ''}}>
                        Latih cara mengendalikan dorongan bunuh diri
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="ti3_3" {{isset($ti3[3]) ? 'checked' : ''}}>
                        Awasi dengan ketat
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="ti3_4" {{isset($ti3[4]) ? 'checked' : ''}}>
