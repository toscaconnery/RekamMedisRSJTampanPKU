            ...
            <table class="table table-striped table-advance table-hover">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                      <a class="btn btn-info" href="{{url('')}}/ri_permintaan_rohani">Isi</a>
                      <a class="btn btn-primary" href="{{url('')}}/ri_permintaan_rohani_read">Lihat</a>
                      <a class="btn btn-success" href="{{url('')}}/ri_permintaan_rohani_edit">Edit</i></a>
                      <a class="btn btn-danger" href="#">Hapus</a>
                    </div>
                  </td>
                  <td>
                    <a class="btn btn-default" href="{{url('')}}/ri_permintaan_rohani_pdf">Cetak</a>
                  </td>
                </tr>
              </tbody>
            </table>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" disabled class="form-control" name="permintaan_rohani" value="{{$permintaan_rohani}}">
                  </div>
                </div>
                <div class="form-group">
