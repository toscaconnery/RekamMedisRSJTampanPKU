...
<body>
  ...
  <section id="main-content">
    <section class="wrapper">
            ...
            <table class="table table-striped table-advance table-hover">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-default" href="{{url('')}}/ri_rencanaklien7_pdf">Cetak</a>
                  </td>
                </tr>
              </tbody>
            </table>
      ...
      <div class="row">
        <div class="col-lg-12">
          <form class="form-horizontal" method="post" action="ri_rencana_klien_7_edit">
            {{ csrf_field() }}
            <section class="panel">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        2. Setelah <input type="text" name="k2" value="{{$k2}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien dapat dilindungi sampai tidak ada keinginan bunuh diri<br>
                        <ul>
                          <li>Ada kontak mata</li>
                    ...
                    <tr>
                      ...
                      <td>
                        3. Setelah <input type="text" name="k3" value="{{$k3}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyebutkan:<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        4. Setelah <input type="text" name="k4" value="{{$k4}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyebutkan:<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        5. Setelah <input type="text" name="k5" value="{{$k5}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyebutkan:<br>
                        <ul>
