...
<body>
  ...
  <section id="main-content">
    <section class="wrapper">
      <div class="row">
        <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa-file-text-o"></i>RENCANA TINDAKAN KEPERAWATAN INTENSIF DEFISIT PERAWATAN DIRI</h3>
        </div>
      </div>
      @include('layouts.bio')
            ...
            <table class="table table-striped table-advance table-hover">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-default" href="{{url('')}}/ri_rencana2_pdf">Cetak</a>
                  </td>
                </tr>
              </tbody>
            </table>
      ...
      <form class="form-horizontal " method="post" action="ri_rencana_keperawatan_2_edit">
        {{ csrf_field() }}
        <div class="row">
          <div class="col-lg-12">
            <section class="panel">
