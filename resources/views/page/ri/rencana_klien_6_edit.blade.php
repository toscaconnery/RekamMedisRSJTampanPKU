...
<body>
  ...
  <section id="main-content">
    <section class="wrapper">
            ...
            <table class="table table-striped table-advance table-hover">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-default" href="{{url('')}}/ri_rencanaklien6_pdf">Cetak</a>
                  </td>
                </tr>
              </tbody>
            </table>
      ...
      <div class="row">
        <div class="col-lg-12">
          <form class="form-horizontal" method="post" action="ri_rencana_klien_6_edit">
            {{ csrf_field() }}
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="text" autocomplete="off" onkeydown="return false" class="form-control sandbox-container" name="tanggal_pengkajian" value="{{$tanggal_pengkajian}}" required>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Jam Pengkajian</label>
                  <div class="col-sm-2">
                    <input type="time" class="form-control" name="jam_pengkajian" value="{{$jam_pengkajian}}" required>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Ruangan</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="ruangan" value="{{$ruangan}}" required>
                  </div>
                </div>
                <div class="form-group">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        1. Setelah <input type="text" name="k1" value="{{$k1}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menunjukkan tanda-tanda percaya kepada perawat:
                        <br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        2. Setelah <input type="text" name="k2" value="{{$k2}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyebutkan:<br>
                        <ul>
                          <li>Isi</li>
                          <li>Waktu</li>
                          <li>Frekuensi</li>
                    ...
                    <tr>
                      <td style="text-align:center;"><input type="text" autocomplete="off" onkeydown="return false" class="form-control sandbox-container" name="tanggal_2b" value="{{$tanggal_2b}}"></td>
                      <td><input type="text" class="form-control" name="nodx_2b" value="{{$nodx_2b}}"></td>
                      <td><input type="text" class="form-control" name="dxk_2b" value="{{$dxk_2b}}"></td>
                      <td></td>
                      <td>
                        2. Setelah <input type="text" name="k2b" value="{{$k2b}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyatakan perasaan dan responnya saat mengalami halusinasi<br>
                        <ul>
                          <li>Marah</li>
                          <li>Takut</li>
                          <li>Sedih</li>
                    ...
                    <tr>
                      ...
                      <td>
                        3.1. Setelah <input type="text" name="k3" value="{{$k3}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyebutkan tindakan yang biasanya dilakukan untuk mengendalikan halusinasinya<br>
                        <br>
                        
                        3.2. Setelah <input type="text" name="k3b" value="{{$k3b}}" style="width: 6em; display: inline;" class="form-control"> kali interkasi klien menyebutkan cara baru mengontrol halusinasi<br>
                        <br>

                        3.3. Setelah <input type="text" name="k3c" value="{{$k3c}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien dapat memilih dan memperagakan cara mengatasi halusinasi (dengar/lihat/penghidu/raba/kecap)<br>
                        <br>

                        3.4. Setelah <input type="text" name="k3d" value="{{$k3d}}" style="width: 6em; display: inline;" class="form-control"> kali interkasi klien melaksanakan cara yang telah dipilih untuk mengendalikan halusinasinya<br>
                        <br>

                        3.5. Setelah <input type="text" name="k3e" value="{{$k3e}}" style="width: 6em; display: inline;" class="form-control"> kali pertemuan klien mengikuti terapi aktivitas kelompok
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        4.1. Setelah <input type="text" name="k4" value="{{$k4}}" style="width: 6em; display: inline;" class="form-control"> kali pertemuan keluarga, keluarga menyatakan setuju untuk mengikuti pertemuan dengan perawat<br>
                        <br>
                        4.2. Setelah <input type="text" name="k4b" value="{{$k4b}}" style="width: 6em; display: inline;" class="form-control"> kali Interkasi keluarga menyebutkan pengertian, tanda dan gejala, proses terjadinya halusinasi dan tindakan untuk mengendalikan halusinasi
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        5.1. Setelah <input type="text" name="k5" value="{{$k5}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyebutkan:<br>
                        <ul>
                          <li>Manfaat minum obat</li>
                          <li>Kerugian tidak minum obat</li>
                          <li>Nama, warna, dosis, efek terapi dan efek samping obat</li>
                        </ul>
                        5.2. Setelah <input type="text" name="k5b" value="{{$k5b}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien mendemonstrasikan penggunaan obat dengan benar<br><br>
                        5.3. Setelah <input type="text" name="k5c" value="{{$k5c}}" style="width: 6em; display: inline;" class="form-control"> kali interaksi klien menyebutkan akibat berhenti minum obat tanpa konsultasi dokter 
                      </td>
                      <td>
