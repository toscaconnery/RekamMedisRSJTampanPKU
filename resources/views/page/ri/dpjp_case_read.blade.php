          ...
          <section class="panel">
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control" name="nama_dpjp" disabled="" value="{{$nama_dpjp}}">
                </div>
              </div>
          ...
          <section class="panel">
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2">
                  <input type="text" class="form-control" name="pengalihan_dpjp_ke" disabled="" value="{{$pengalihan_dpjp_ke}}">
                </div>
                <label class="col-sm-2 control-label">Tanggal</label>
                <div class="col-sm-2">
                  <input type="text" class="form-control" id="dp1" name="tanggal_pengalihan" disabled="" value="{{$tanggal_pengalihan}}">
                </div>
              </div>
              <div class="form-group">
          ...
          <section class="panel">
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" name="cm_1" disabled="" value="{{$cm_1}}">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">Case Manager 2</label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" name="cm_2" disabled="" value="{{$cm_2}}">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">Case Manager 3</label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" name="cm_3"  disabled="" value="{{$cm_3}}">
                </div>
              </div>
            </div>
          </section>
