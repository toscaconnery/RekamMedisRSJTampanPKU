...
<body>
  ...
  <section id="main-content">
    <section class="wrapper">
      ...
      <div class="row">
        <div class="col-lg-12">
          <form class="form-horizontal" method="post" action="ri_rencana_klien_2_edit">
            {{ csrf_field() }}
            <section class="panel">
              <header class="panel-heading">
                Rencana Tindakan
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        1. Setelah <input type="text" name="k1" style="width: 4em; display: inline;" class="form-control" value="{{$k1}}"> kali interaksi, klien menunjukkan ekspresi wajah bersahabat, menunjukkan rasa senang, ada kontak mata, mau berjabat tangan, mau menyebutkan nama, mau menjawab salam, klien mau duduk berdampingan dengan perawat, mau mengutarakan masalah yang dihadapi.
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        2. Setelah <input type="text" name="k2" value="{{$k2}}" style="width: 4em; display: inline;" class="form-control"> kali interaksi klien menyebutkan:<br>
                        <ul>
