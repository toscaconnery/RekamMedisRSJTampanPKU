...
<body>
  ...
  <section id="main-content">
    <section class="wrapper">
            ...
            <table class="table table-striped table-advance table-hover">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-default" href="{{url('')}}/ri_rencanaklien3_pdf">Cetak</a>
                  </td>
                </tr>
              </tbody>
            </table>
      ...
      <div class="row">
        <div class="col-lg-12">
          <form class="form-horizontal" method="post" action="ri_rencana_klien_3_edit">
            {{ csrf_field() }}
            <section class="panel">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        1.1. Setelah <input type="text" name="k1" value="{{$k1}}" style="width: 6em; display: inline;" class="form-control"> x interaksi klien:<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        2.1. Setelah <input type="text" name="k2" value="{{$k2}}" style="width: 6em; display: inline;" class="form-control"> x interaksi klien: <br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        3. Setelah <input type="text" name="k3" value="{{$k3}}" style="width: 6em; display: inline;" class="form-control"> x interaksi klien:<br>
                        <ul>
