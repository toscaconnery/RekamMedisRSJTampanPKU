            ...
            <table class="table table-striped table-advance table-hover">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-default" href="{{url('')}}/ri_permintaan_second_pdf">Cetak</a>
                  </td>
                </tr>
              </tbody>
            </table>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"></label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="permintaan_opini" disabled="" value="{{$permintaan_opini}}">
                  </div>
                </div>
              </div>
            </section>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="nama_pasien_wali" disabled="" value="{{$nama_pasien_wali}}">
                  </div>
                </div>
              </div>
            </section>
