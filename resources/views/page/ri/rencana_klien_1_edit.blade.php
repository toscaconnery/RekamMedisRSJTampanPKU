...
<body>
  ...
  <section id="main-content">
    <section class="wrapper">
            ...
            <table class="table table-striped table-advance table-hover">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-default" href="{{url('')}}/ri_rencanaklien1_pdf">Cetak</a>
                  </td>
                </tr>
              </tbody>
            </table>
      ...
      <form class="form-horizontal" method="post" action="ri_rencana_klien_1_edit">
        {{ csrf_field() }}
        <div class="row">
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="text" autocomplete="off" onkeydown="return false" class="form-control sandbox-container" name="tanggal_pengkajian" required value="{{$tanggal_pengkajian}}">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Jam Pengkajian</label>
                  <div class="col-sm-2">
                    <input type="time" class="form-control" name="jam_pengkajian" required value="{{$jam_pengkajian}}">
                  </div>
                </div>
                <div class="form-group">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        1. Setelah <input type="text" name="k1" style="width: 6em; display: inline;" class="form-control" value="{{$k1}}"> x pertemuan klien menunjukkan tanda-tanda percaya kepada perawat:<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        2. Setelah <input type="text" name="k2" style="width: 6em; display: inline;" class="form-control" value="{{$k2}}"> x pertemuan klien menceritakan penyebab perilaku kekerasan yang dilakukannya:<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        3. Setelah <input type="text" name="k3" style="width: 6em; display: inline;" class="form-control" value="{{$k3}}"> x pertemuan klien menceritakan tanda-tanda saat terjadi perilaku kekerasan<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        4. Setelah <input type="text" name="k4" style="width: 6em; display: inline;" class="form-control" value="{{$k4}}"> x pertemuan klien menjelaskan:<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        5. Setelah <input type="text" name="k5" value="{{$k5}}" style="width: 6em; display: inline;" class="form-control"> x pertemuan klien menjelaskan akibat tindak kekerasan yang dilakukannya<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        6. Setelah <input type="text" name="k6" value="{{$k6}}" style="width: 6em; display: inline;" class="form-control"> x pertemuan klien :<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        7. Setelah <input type="text" name="k7" value="{{$k7}}" style="width: 6em; display: inline;" class="form-control"> x pertemuan klien memperagakan cara mengontrol perilaku kekerasan:<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        8. Setelah  <input type="text" name="k8" value="{{$k8}}" style="width: 6em; display: inline;" class="form-control"> x pertemuan keluarga:<br>
                        <ul>
                    ...
                    <tr>
                      <td style="text-align:center;"><input type="text" autocomplete="off" onkeydown="return false" class="form-control sandbox-container" name="tanggal_9" value="{{$tanggal_9}}"></td>
                      <td><input type="text" class="form-control" name="nodx_9" value="{{$nodx_9}}"></td>
                      <td><input type="text" class="form-control" name="dxk_9" value="{{$dxk_9}}"></td>
                      <td>
                        9. Klien menggunakan obat sesuai program yang telah ditetapkan
                      </td>
                      <td>
                        9.1. Setelah <input type="text" name="k9" value="{{$k9}}" style="width: 6em; display: inline;" class="form-control"> x pertemuan klien menjelaskan:<br>
                        <ul>
                        ...
                        9.2. Setelah <input type="text" name="k10" value="{{$k10}}" style="width: 6em; display: inline;" class="form-control"> x pertemuan klien menggunakan obat sesuai program 
                      </td>
                      <td>
