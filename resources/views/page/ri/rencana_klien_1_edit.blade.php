                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        1. Setelah <input type="text" name="k1" style="width: 4em; display: inline;" class="form-control" value="{{$k1}}"> x pertemuan klien menunjukkan tanda-tanda percaya kepada perawat:<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        2. Setelah <input type="text" name="k2" style="width: 4em; display: inline;" class="form-control" value="{{$k2}}"> x pertemuan klien menceritakan penyebab perilaku kekerasan yang dilakukannya:<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        3. Setelah <input type="text" name="k3" style="width: 4em; display: inline;" class="form-control" value="{{$k3}}"> x pertemuan klien menceritakan tanda-tanda saat terjadi perilaku kekerasan<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        4. Setelah <input type="text" name="k4" style="width: 4em; display: inline;" class="form-control" value="{{$k4}}"> x pertemuan klien menjelaskan:<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        5. Setelah <input type="text" name="k5" value="{{$k5}}" style="width: 4em; display: inline;" class="form-control"> x pertemuan klien menjelaskan akibat tindak kekerasan yang dilakukannya<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        6. Setelah <input type="text" name="k6" value="{{$k6}}" style="width: 4em; display: inline;" class="form-control"> x pertemuan klien :<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        7. Setelah <input type="text" name="k7" value="{{$k7}}" style="width: 4em; display: inline;" class="form-control"> x pertemuan klien memperagakan cara mengontrol perilaku kekerasan:<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        8. Setelah  <input type="text" name="k8" value="{{$k8}}" style="width: 4em; display: inline;" class="form-control"> x pertemuan keluarga:<br>
                        <ul>
                    ...
                    <tr>
                      ...
                      <td>
                        9.1. Setelah <input type="text" name="k9" value="{{$k9}}" style="width: 4em; display: inline;" class="form-control"> x pertemuan klien menjelaskan:<br>
                        <ul>
                        ...
                        9.2. Setelah <input type="text" name="k10" value="{{$k10}}" style="width: 4em; display: inline;" class="form-control"> x pertemuan klien menggunakan obat sesuai program 
                      </td>
                      <td>
