      ...
      <div class="row">
        <div class="col-lg-12">
          <form class="form-horizontal form-validate" method="post" id="register_form" action="igd_asesmen_awal_rawat_darurat_perawat">
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="text" value="{{date("d/m/Y")}}" class="form-control required sandbox-container" name="tanggal_kedatangan">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <div class="radio">
                      <label>
                        <input type="radio" name="visum" value="true" >
                        Dengan disertai VISUM ET REPERTUM PSIKIATRIKUM
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="visum" value="false" >
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="checkbox">
                      <div class="block">
                        ...
                        <input type="text" name="penyakit_malnutrisi_lain" class="form-control">
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {{-- humpty dumpty --}}
            <section class="panel hidden_panel" id="humpty_dumpty_panel">
              <header class="panel-heading">
                HUMPTY DUMPTY (Anak-anak)
              </header>
              <div class="panel-body">
            ...
            {{-- morse --}}
            <section class="panel hidden_panel" id="morse_panel">
              <header class="panel-heading">
                MORSE (Dewasa)
              </header>
              <div class="panel-body">
            ...
            {{-- edmunson --}}
            <section class="panel hidden_panel" id="edmunson_panel">
              <header class="panel-heading">
                EDMUNSON (Jiwa)
              </header>
              <div class="panel-body">
