...
<head>
  ...
  <!-- bootstrap theme -->
  <link href="admin_bootstrap/css/bootstrap-theme.css" rel="stylesheet">
  <!--external css-->
  <!-- font icon -->
  <link href="admin_bootstrap/css/elegant-icons-style.css" rel="stylesheet" />
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <a class="btn btn-success" href="{{url('')}}/pdf"><i class="icon_check_alt2"></i></a>
