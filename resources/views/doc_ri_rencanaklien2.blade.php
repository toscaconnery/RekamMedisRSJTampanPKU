...
<h2 align="center" style="font-size:100%">RENCANA TINDAKAN KEPERAWATAN<br>KLIEN DENGAN GANGGUAN KONSEP DIRI : HARGA DIRI RENDAH</h2>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td class="box-top">
        1. Setelah {{$k1}} kali interaksi, klien menunjukkan ekspresi wajah bersahabat, menunjukkan rasa senang, ada kontak mata, mau berjabat tangan, mau menyebutkan nama, mau menjawab salam, klien mau duduk berdampingan dengan perawat, mau mengutarakan masalah yang dihadapi.
      </td>
      <td class="box-top">
    ...
    <tr>
      ...
      <td class="box-top">2. Klien dapat mengidentifikasi aspek positif dan kemampuan yang dimiliki.</td>
      <td class="box-top">
        2. Setelah {{$k2}} kali interaksi klien menyebutkan:<br>
        <ul>
