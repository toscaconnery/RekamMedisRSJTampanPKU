...
class Pdf_igd_Controller extends Controller
{
    ...
    public function pdf_igd_asesmen()
    {
        ob_clean();
        ...
        $view = View::make('doc_igd_asesmen');
        $contents = $view->render();
    ...
    public function pdf_igd_suicide()
    {
        ob_clean();
        ...
        $view = View::make('doc_igd_suicide');
        $contents = $view->render();
    ...
    public function pdf_igd_kemajuan()
    {
        ob_clean();
        ...
        $view = View::make('doc_igd_kemajuan');
        $contents = $view->render();
    ...
    public function pdf_igd_perkembangan()
    {
        ob_clean();
        ...
        $view = View::make('doc_igd_perkembangan');
        $contents = $view->render();
