...
class Pdf_rj_Controller extends Controller
{
    ...
    public function pdf_rj_infoedu()
    {
        ob_clean();
    ...
    public function pdf_rj_catatan_perkembangan()
    {
        ob_clean();
        ...
        $view = View::make('doc_rj_catatan_perkembangan');
        $contents = $view->render();
    ...
    public function pdf_rj_stressor()
    {
        ob_clean();
        ...
        $view = View::make('doc_rj_stressor');
        $contents = $view->render();
    ...
    public function pdf_rj_konselinghiv()
    {
        ob_clean();
        ...
        $view = View::make('doc_rj_konselinghiv');
        $contents = $view->render();
    ...
    public function pdf_rj_izinvct()
    {
        ob_clean();
