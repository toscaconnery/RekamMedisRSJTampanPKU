...
class Pdf_ri_Controller extends Controller
{
    public function pdf_ri_resume()
    {
        ob_clean();
    ...
    public function pdf_ri_dpjpcase()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_dpjpcase');
        $contents = $view->render();
    ...
    public function pdf_ri_permintaan_privasi()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_permintaan_privasi');
        $contents = $view->render();
    ...
    public function pdf_ri_hakkewajiban()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_hakkewajiban');
        $contents = $view->render();
    ...
    public function pdf_ri_permintaan_rohani()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_permintaan_rohani');
        $contents = $view->render();
    ...
    public function pdf_ri_permintaan_notresucitate()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_permintaan_notresucitate');
        $contents = $view->render();
    ...
    public function pdf_ri_permintaan_resucitate()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_permintaan_resucitate');
        $contents = $view->render();
        ...
        $mpdf->Output('ri_permintaan_resucitate.pdf',\Mpdf\Output\Destination::INLINE);
    }

    public function pdf_ri_persetujuan_tindakan()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_persetujuan_tindakan');
        $contents = $view->render();
    ...
    public function pdf_ri_penolakan_tindakan()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_penolakan_tindakan');
        $contents = $view->render();
        ...
        $mpdf->SetHTMLFooter('<hr>
            <table width="100%" style="vertical-align: bottom; font-family: "arial", Times, serif; 
                ...
                <tr>
                    <td width="33%">{DATE j-m-Y}</td>
                    <td width="33%" align="center">{PAGENO}/{nbpg}</td>
                    <td width="33%" style="text-align: right;">RM. 12.01.RI JULI 2015</td>
                </tr>
            </table>'); 
        ...
        $mpdf->Output('ri_penolakan_tindakan.pdf',\Mpdf\Output\Destination::INLINE);
    }

    public function pdf_ri_asesmen()
    {
        ob_clean();
    ...
    public function pdf_ri_persetujuan_umum()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_persetujuan_umum');
        $contents = $view->render();
    ...
    public function pdf_ri_suicide()
    {
        ob_clean();
    ...
    public function pdf_ri_edmunson()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_edmunson');
        $contents = $view->render();
    ...
    public function pdf_ri_catatan_perkembangan()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_catatan_perkembangan');
        $contents = $view->render();
    ...
    public function pdf_ri_evaluasi()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_evaluasi');
        $contents = $view->render();
    ...
    public function pdf_ri_monitoring()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_monitoring');
        $contents = $view->render();
    ...
    public function pdf_ri_rekonsiliasi()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_rekonsiliasi');
        $contents = $view->render();
    ...
    public function pdf_ri_rawat_napza()
    {
        ...
        $view = View::make('doc_ri_rawat_napza');
        $contents = $view->render();
    ...
    public function pdf_ri_edukasi()
    {
        ob_clean();
    ...
    public function pdf_ri_pemulangan()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_pemulangan');
        $contents = $view->render();
    ...
    public function pdf_ri_konsultasi()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_konsultasi');
        $contents = $view->render();
    ...
    public function pdf_ri_internal()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_internal');
        $contents = $view->render();
    ...
    public function pdf_ri_eksternal()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_eksternal');
        $contents = $view->render();
    ...
    public function pdf_ri_pulang_paksa()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_pulang_paksa');
        $contents = $view->render();
    ...
    public function pdf_ri_residen()
    {
        ob_clean();
        ...
        $mpdf->SetHTMLFooter('<hr>
            <table width="100%" style="vertical-align: bottom; font-family: "arial", Times, serif; 
                ...
                <tr>
                    <td width="33%">{DATE j-m-Y}</td>
                    <td width="33%" align="center">{PAGENO}/{nbpg}</td>
                    <td width="33%" style="text-align: right;">RM. 37.00.RI JULI 2015</td>
                </tr>
            </table>'); 
        ...
        $mpdf->Output('ri_residen.pdf',\Mpdf\Output\Destination::INLINE);
    }

    public function pdf_ri_surat_kuasa()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_surat_kuasa');
        $contents = $view->render();
    ...
    public function pdf_ri_pernyataan()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_pernyataan');
        $contents = $view->render();
    ...
    public function pdf_ri_informasi()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_informasi');
        $contents = $view->render();
    ...
    public function pdf_ri_psikologis()
    {
        ...
        $view = View::make('doc_ri_psikologis');
        $contents = $view->render();
    ...
    public function pdf_ri_serah_terima()
    {
        ob_clean();
        ...
        $view = View::make('doc_ri_serah_terima');
        $contents = $view->render();
