...
class RIPenolakanTindakanController extends Controller
{
    ...
    public function post_ri_penolakan_tindakan(Request $request)
    {
        ...
        $daftar_dokumen->ri_penolakan_tindakan = True;
        $daftar_dokumen->save();

    	return redirect('daftar_dokumen');
    }

    public function get_ri_penolakan_tindakan_data()
    {
        $id_pasien = Session::get('id_pasien');
    	$pasien = RIPenolakanTindakan::where('id_regis', $id_pasien)->first();
    ...
    {
        $this->get_ri_penolakan_tindakan_data();
        return view('page.ri.penolakan_tindakan_read', $this->data);
    }

    public function get_ri_penolakan_tindakan_edit()
    {
        $this->get_ri_penolakan_tindakan_data();
        return view('page.ri.penolakan_tindakan_edit', $this->data);
    }

    public function post_ri_penolakan_tindakan_edit(Request $request)
    {
        $id_pasien = Session::get('id_pasien');
        $data = RIPenolakanTindakan::where('id_regis', $id_pasien)->first();
        $data->dokter_pelaksana_tindakan = $request->dokter_pelaksana_tindakan;
        $data->pemberi_informasi = $request->pemberi_informasi;
        $data->penerima_informasi = $request->penerima_informasi;
        $data->jenis_informasi_1 = $request->jenis_informasi_1;
    ...
    public function ri_penolakan_tindakan_pdf()
    {
        ...
        $view = View::make('doc_ri_penolakan_tindakan',$this->data);
